...
import { chmodSync, copyFileSync, existsSync, linkSync, lstatSync, mkdirSync, writeFileSync, readFileSync, readdirSync, renameSync, rmSync, statSync, symlinkSync, utimesSync } from 'node:fs';
