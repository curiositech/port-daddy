...
describe("roadmap-popper", () => {
  ...
  test("respects harbor scoping", () => { seed(db, [{ id: "1", slug: "pd", summary: "p", harbor: "port-daddy", eligible: 1, touched: 200 }, { id: "2", slug: "wd", summary: "w", harbor: "windags", eligible: 1, touched: 300 }]); expect(popper.nextCandidate("port-daddy")?.slug).toBe("pd"); expect(popper.nextCandidate("windags")?.slug).toBe("wd"); });
});
