...
describe('sugar.begin', () => {
  ...
  test('closed-session takeover requires the predecessor actor and preserves its stamp', () => {
    const { sugar, sessions } = setup();
    ...
    expect(sessions.get(resumed.sessionId).session.metadata.identity).toEqual(
