...
```json
{
  ...
  "score": 26,
  "findings": [
    { "severity": "critical", "id": "identity-gated-no-local-path", "message": "Feature \"cloud-only-team-dashboard\" requires identity and has no local-only path — account/passkey sign-in is essential, not optional." },
