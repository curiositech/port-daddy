...
- [references/cdm-methodology-as-agent-design-protocol.md](references/cdm-methodology-as-agent-design-protocol.md) — The Critical Decision Method as a Protocol for Designing Agent Capabilities.
- [references/decision-support-vs-decision-replacement-a-critical-distinction.md](references/decision-support-vs-decision-replacement-a-critical-distinction.md) — Decision Support vs. Decision Replacement: Building Systems That Amplify Expert Judgment.
- [references/expert-knowledge-structure-layers-and-abstraction.md](references/expert-knowledge-structure-layers-and-abstraction.md) — The Layered Structure of Expert Knowledge: From Perception to Strategy.
- [references/failure-modes-in-expert-judgment-and-agent-design.md](references/failure-modes-in-expert-judgment-and-agent-design.md) — Failure Modes in Expert Judgment: Warnings for Intelligent System Design.
- [references/recognition-primed-decision-making-core-model.md](references/recognition-primed-decision-making-core-model.md) — Recognition-Primed Decision Making: The Core Model and Its Implications for Agent Systems.
- [references/situation-assessment-as-primary-cognitive-task.md](references/situation-assessment-as-primary-cognitive-task.md) — Situation Assessment as the Primary Cognitive Task: What Agents Must Get Right First.
- [references/tacit-knowledge-elicitation-for-agent-knowledge-bases.md](references/tacit-knowledge-elicitation-for-agent-knowledge-bases.md) — The Problem of Tacit Knowledge: How to Extract What Experts Cannot Articulate.
- [references/the-boundary-of-routine-where-expertise-becomes-visible.md](references/the-boundary-of-routine-where-expertise-becomes-visible.md) — The Boundary of Routine: Where Expertise Becomes Visible and Transferable.
