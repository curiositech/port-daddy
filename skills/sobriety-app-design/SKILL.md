...
io-contract:
  ...
  produces:
    - kind: design-doc
      description: >-
        Trauma-informed UX specifications for recovery app features (counters, check-ins, crisis buttons, gamification),
        including color palettes, interaction patterns, and SAMHSA principle compliance
      format: markdown
    - kind: diagram
      description: >-
        Wireframes and flow diagrams for sobriety counters, craving trackers, meeting finders, sponsor communication,
        and milestone celebration screens
      format: svg
    - kind: critique
      description: >-
        Review of existing recovery app designs against trauma-informed principles, retention patterns, and ethical
        gamification standards
      format: markdown
    - kind: refactor-plan
      description: >-
        Specific recommendations to redesign recovery app features for safety, peer support, user empowerment, and
