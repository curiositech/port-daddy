...
- Imported from the global windags skill catalog (SKILL.md only) and upgraded to the port-daddy agentic-family standard.
...
- Initial skill creation in the windags global skill catalog: CLEAR framework, optimization techniques table, prompt patterns, common issues/fixes, and 4 anti-patterns.
