...
metadata:
  ...
  io-contract:
    kind: none
    covers:
      - multiagent system architectures (reactive, deliberative, hybrid)
      - environment characterization and agent design trade-offs
      - coordination protocols and distributed knowledge reasoning
      - commitment strategies and agent autonomy models
      - epistemic logic and belief/knowledge formalization
      - negotiation, resource allocation, and task decomposition
      - failure modes and verification in distributed systems
