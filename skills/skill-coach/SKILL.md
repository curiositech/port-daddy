...
- [examples/good/clip-aware-embeddings/SKILL_.md](examples/good/clip-aware-embeddings/SKILL_.md) — CLIP-Aware Image Embeddings.
- [examples/good/clip-aware-embeddings/scripts/validate_clip_usage.py](examples/good/clip-aware-embeddings/scripts/validate_clip_usage.py) — validate_clip_usage.py.
