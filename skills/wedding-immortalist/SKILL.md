...
- [references/face-clustering-aesthetics.md](references/face-clustering-aesthetics.md) — Face Clustering & Aesthetic Photo Selection.
- [references/gaussian-splatting-pipeline.md](references/gaussian-splatting-pipeline.md) — 3D Gaussian Splatting Pipeline for Weddings.
- [references/theme-extraction.md](references/theme-extraction.md) — Wedding Theme Extraction & Design System.
