...
- [references/calibration-driven-learning-for-agent-systems.md](references/calibration-driven-learning-for-agent-systems.md) — Calibration-Driven Learning: Building Expert-Like Decision Patterns Through Systematic Comparison.
- [references/constraint-as-cognitive-forcing-function.md](references/constraint-as-cognitive-forcing-function.md) — The One-Inch Box: How Constraints Force Better Thinking in Agent Systems.
- [references/expert-consensus-without-ground-truth.md](references/expert-consensus-without-ground-truth.md) — Learning From Expert Disagreement: How Agents Can Develop Judgment Without Ground Truth.
- [references/facilitation-free-scalable-expertise-transfer.md](references/facilitation-free-scalable-expertise-transfer.md) — Facilitation-Free Expertise Transfer: How ShadowBox Enables Learning Without Expert Presence.
- [references/multi-dimensional-cognitive-assessment.md](references/multi-dimensional-cognitive-assessment.md) — Multi-Dimensional Cognitive Assessment: Why Different Box Types Reveal Different Aspects of Expertise.
- [references/progressive-revelation-and-commitment.md](references/progressive-revelation-and-commitment.md) — Progressive Information Revelation and Irrevocable Commitment: How Sequential Constraint Builds Expertise.
- [references/scenario-based-expertise-transfer.md](references/scenario-based-expertise-transfer.md) — Scenario-Based Expertise Transfer: Why Context-Rich Cases Beat Abstract Principles for Agent Training.
