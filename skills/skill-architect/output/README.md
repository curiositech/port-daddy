...
1. Tighten description: `[What] [When to use]. NOT for [Exclusions]`
...
`[What it does] [When to use]. NOT for [Exclusions].`

The description is the single most important line for activation. See `references/description-guide.md` for 7 bad-to-good examples.
...
23 diagram types are available. See `references/visual-artifacts.md` for the full catalog.
...
└── references/
    ...
    ├── activation-debugging.md       # Activation failure diagnosis
...
- **v2.4.0** (2026-03-16) -- SKILL.md compressed to 381 lines; Platform Constraints and Common Rejection Causes removed (duplicated reference/validator); honest EVALUATION.md with corrected iter-2 scores
- **v2.3.0** (2026-03-16) -- Self-consistency fixes: phantom references in EVALUATION.md, invented frontmatter keys removed, validation tool hardened
- **v2.2.0** (2026-03-10) -- Validation fixes, activation-debugging.md, Mermaid in lifecycle/composition, scoring rubric 6th dimension
- **v2.1.0** (2026-02-05) -- Visual artifacts: Mermaid diagram guide, 23 diagram types
- **v2.0.0** (2026-02-05) -- Major rewrite: description guide, subagent design, frontmatter fields, lazy loading
