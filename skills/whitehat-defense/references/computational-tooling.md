...
on every change. Lemmas live in `proofs/<protocol>.pv`.
...
1. **English statement** in a security spec doc (`docs/security/properties.md`, proposed).
2. **Formal lemma** in Tamarin/ProVerif/TLA+/Z3 (`proofs/`).
