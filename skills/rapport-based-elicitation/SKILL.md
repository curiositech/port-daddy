...
- [references/autonomy-preservation-in-elicitation.md](references/autonomy-preservation-in-elicitation.md) — Autonomy Preservation in Information Elicitation: Why Giving Up Control Produces More Information.
- [references/coercion-contaminates-information.md](references/coercion-contaminates-information.md) — The Accusatorial Failure Mode: Why Coercive Approaches Corrupt the Information They Seek.
- [references/evidence-based-practice-adoption-barriers.md](references/evidence-based-practice-adoption-barriers.md) — The Gap Between Evidence and Practice: Why Proven Methods Fail to Displace Inferior Ones.
- [references/gap-between-knowing-and-doing.md](references/gap-between-knowing-and-doing.md) — The Knowing-Doing Gap: Why Familiarity with a Method Predicts Almost Nothing About Competence.
- [references/information-extraction-as-indirect-problem.md](references/information-extraction-as-indirect-problem.md) — Information Extraction Is an Indirect Problem: The Rapport-Cooperation-Disclosure Chain.
- [references/mediated-causal-chains-in-agent-design.md](references/mediated-causal-chains-in-agent-design.md) — Mediated Causal Chains: How to Design and Reason About Indirect Pathways to Outcomes.
- [references/resistance-as-diagnostic-signal.md](references/resistance-as-diagnostic-signal.md) — Resistance as a Diagnostic Signal: What a Source's Reluctance Reveals About the Interaction.
- [references/three-layers-of-rapport-architecture.md](references/three-layers-of-rapport-architecture.md) — The Three-Layer Architecture of Effective Information Elicitation.
- [references/trust-reciprocity-and-the-cooperative-threshold.md](references/trust-reciprocity-and-the-cooperative-threshold.md) — Trust, Reciprocity, and the Cooperative Threshold: How Information Exchange Becomes Possible.
