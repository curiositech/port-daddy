...
**Fix:** Cut the quote unless it's real, correctly attributed, and pivotal. Better: replace it with a concrete artifact — a customer's actual words, a real data point.
