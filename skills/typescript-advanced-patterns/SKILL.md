...
- [references/branded-types.md](references/branded-types.md) — Branded Types Reference.
- [references/type-safe-patterns.md](references/type-safe-patterns.md) — Type-Safe Patterns Reference.
