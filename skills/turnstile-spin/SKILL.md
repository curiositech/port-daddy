...
- [references/astro.md](references/astro.md) — Astro.
- [references/hugo.md](references/hugo.md) — Hugo.
- [references/nextjs-app.md](references/nextjs-app.md) — Next.js (App Router).
- [references/nextjs-pages.md](references/nextjs-pages.md) — Next.js (Pages Router).
- [references/sveltekit.md](references/sveltekit.md) — SvelteKit.
- [references/vanilla-html.md](references/vanilla-html.md) — Vanilla HTML.
- [tests/validation.md](tests/validation.md) — Skill validation cases.
