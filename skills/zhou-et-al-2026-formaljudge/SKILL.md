...
description: Bounded neuro-symbolic oversight research using Dafny/Z3; not a guarantee of agent correctness or deployed enforcement
...
**Evidence boundary:** FormalJudge studies a Dafny/Z3 oversight design in its stated evaluation. It does not turn extracted facts into ground truth, prove an arbitrary agent correct, or establish local deployment or complete mediation.
...
**Bounded result:** a solver can establish consequences of the supplied formal specification and facts; it cannot establish that extraction, specification, or external observations are complete or true.
...
**Reported-paper boundary:** see arXiv:2602.11136 for its actual evaluated outcomes. Do not transfer its numbers or methodology to a local system without a pinned reproduction.
