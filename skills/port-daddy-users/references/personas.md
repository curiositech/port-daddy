...
- **Dealbreakers**: Any claim in the docs that the code doesn't actually back up. A "coming soon" security feature that's central today.
...
- **Friction tolerance**: Zero tolerance for anything that resembles a pattern he's seen fail before (vague roadmap promises, "coming soon" decisive features, hype language disconnected from working code).
