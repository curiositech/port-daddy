...
- [references/automation-surprises-opacity-risk.md](references/automation-surprises-opacity-risk.md) — Automation Surprises: The Opacity Failure Mode in Agent Systems.
- [references/cognition-distribution-coordination-without-central-control.md](references/cognition-distribution-coordination-without-central-control.md) — Distributed Cognition: How Intelligence Emerges Without Central Control.
- [references/expert-knowledge-elicitation-for-agent-training.md](references/expert-knowledge-elicitation-for-agent-training.md) — Knowledge Elicitation: Getting What Experts Know Into Agent Systems.
- [references/expertise-as-alternative-path-generation.md](references/expertise-as-alternative-path-generation.md) — Expertise as the Capacity to Generate Alternative Paths.
- [references/human-centered-design-for-agent-orchestration.md](references/human-centered-design-for-agent-orchestration.md) — Human-Centered (Agent-Centered) Design Principles for Orchestration Systems.
- [references/linear-decomposition-failure-modes.md](references/linear-decomposition-failure-modes.md) — Why Linear Task Decomposition Fails — And What To Do Instead.
- [references/skill-rules-knowledge-hierarchy-agent-architecture.md](references/skill-rules-knowledge-hierarchy-agent-architecture.md) — Rasmussen's SRK Framework: A Hierarchy of Agent Competence.
- [references/sociotechnical-systems-design-lessons.md](references/sociotechnical-systems-design-lessons.md) — Sociotechnical System Design: The Lessons That Keep Getting Ignored.
- [references/true-work-vs-prescribed-work-gap.md](references/true-work-vs-prescribed-work-gap.md) — The Gap Between Prescribed Work and True Work — And Why Agents Must Bridge It.
