...
- [references/ai-assistant-patterns.md](references/ai-assistant-patterns.md) — AI Assistant Patterns: The Clippy Paradigm.
- [references/component-library.md](references/component-library.md) — Win95 Component Library.
- [references/mobile-pocket-pc.md](references/mobile-pocket-pc.md) — Mobile: The Pocket PC Paradigm.
