# references for bdi-agency-model

Imported supporting material. Load a listed file only when it serves the active task.

## Imported source navigation

- [Learning and Adaptation: The Missing Piece in Basic BDI](learning-the-missing-piece.md) — imported supporting material.
- [Multi-Agent Coordination Through Commitments](multi-agent-commitment-and-coordination.md) — imported supporting material.
- [Rational Commitment: When to Stick with Plans and When to Reconsider](rational-commitment-and-reconsideration.md) — imported supporting material.
