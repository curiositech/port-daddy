...
- BELIEF and PREFERENCE are semantically distinct but mechanically identical in Week 2; the distinction is pivotal only in Week 3 belief markets, where `confidence_stake` and `proposition` enter settlement logic.
