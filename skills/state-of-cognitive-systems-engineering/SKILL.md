...
metadata:
  ...
  io-contract:
    kind: none
    covers:
      - cognitive systems engineering theory and research
      - recognition-primed decision making (Klein)
      - naturalistic decision-making
      - task decomposition and agent architecture design
      - human-machine coordination and automation surprises
...
- `references/automation-surprises-and-coordination-failure.md` — Documents how automation paradoxically makes routine ops reliable but rare failures catastrophic. **Read when** designing human-AI handoffs or diagnosing unexpected system behavior.

- `references/automation-surprises-opacity-risk.md` — Defines automation surprises: systems that operate normally while doing something other than intended. **Read when** evaluating agent opacity or designing oversight mechanisms.

- `references/cognition-distribution-coordination-without-central-control.md` — Explains how intelligent systems (teams, orgs, tool ecosystems) perform without central control via distributed cognition. **Read when** designing multi-agent orchestration without bottlenecks.

- `references/cognitive-task-analysis-for-skill-specification.md` — Contrasts requirements analysis with cognitive task analysis for expertise-based capabilities. **Read when** specifying what an agent should actually do beyond I/O contracts.

- `references/expert-knowledge-elicitation-for-agent-training.md` — Addresses tacit knowledge capture: the knowledge practitioners have but cannot articulate. **Read when** building systems that encode expert reasoning.

- `references/expertise-acquisition-stages-for-agent-capability-design.md` — Maps expertise development stages (novice to expert) and implications for agent design. **Read when** evaluating agent proficiency levels or designing capability progression.

- `references/expertise-as-alternative-path-generation.md` — Defines expertise as capacity to generate alternative paths when known procedures fail. **Read when** designing agents to handle degraded conditions or unexpected situations.

- `references/human-centered-design-for-agent-orchestration.md` — Applies CSE's core principle: machines adapt to intelligent agents, not vice versa. **Read when** designing orchestration systems that empower rather than constrain.

- `references/human-centered-inversion-for-agent-design.md` — Elaborates the human-centered inversion thesis and its design implications. **Read when** rethinking agent architecture to serve intelligence rather than enforce procedures.

- `references/invariant-task-fallacy-and-agent-pipelines.md` — Warns against fixed linear task sequences; real work is context-sensitive path selection. **Read when** decomposing complex tasks or diagnosing brittle pipelines.

- `references/linear-decomposition-failure-modes.md` — Details why linear task decomposition fails and alternative approaches. **Read when** designing task decomposition that survives unexpected conditions.

- `references/recognition-primed-decision-making-for-agents.md` — Explains Klein's RPD model: experts recognize situations, simulate, then act—not enumerate options. **Read when** designing fast, competent decision-making under time pressure.

- `references/situated-cognition-and-context-dependence.md` — Shows why context is not optional background; cognition is fundamentally situated. **Read when** understanding why decontextualized agent reasoning fails.

- `references/skill-rules-knowledge-hierarchy-agent-architecture.md` — Introduces Rasmussen's SRK framework: three levels of agent competence (skill, rule, knowledge). **Read when** designing agent architectures that span routine and novel situations.

- `references/sociotechnical-systems-design-lessons.md` — Defines sociotechnical workplace as the unit of analysis; cannot design for agent in isolation. **Read when** designing human-AI coordination or system-level resilience.

- `references/the-gap-between-knowing-and-doing-in-complex-systems.md` — Explains why understanding a problem doesn't solve it; gap between knowing and competent action. **Read when** diagnosing why agents fail despite correct problem understanding.

- `references/the-knowledge-elicitation-problem.md` — Shows why experts cannot simply tell you what they know; tacit knowledge resists articulation. **Read when** attempting to capture or encode expert reasoning.

- `references/true-work-vs-prescribed-work-gap.md` — Distinguishes prescribed work (procedures, specs) from true work practitioners actually perform. **Read when** understanding why agents fail to handle real-world conditions.
