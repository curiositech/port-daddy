...
- [references/analytical-prescriptions-vs-recognitional-expertise.md](references/analytical-prescriptions-vs-recognitional-expertise.md) — When Analytical Prescriptions Harm Expert Performance: The Case Against Universal Optimization.
- [references/critical-decision-method-for-knowledge-elicitation.md](references/critical-decision-method-for-knowledge-elicitation.md) — The Critical Decision Method: Extracting Expert Knowledge from Operational Memory.
- [references/distributed-decision-making-without-central-control.md](references/distributed-decision-making-without-central-control.md) — Distributed Decision-Making Without Central Control: How Experts Coordinate at Scale.
- [references/expertise-gap-cues-vs-inferences.md](references/expertise-gap-cues-vs-inferences.md) — The Expertise Gap: Why Experts and Novices Notice the Same Things But See Different Worlds.
- [references/failure-modes-in-operational-decision-systems.md](references/failure-modes-in-operational-decision-systems.md) — Failure Modes in Operational Decision Systems: What Can Go Wrong and Why.
- [references/progressive-deepening-mental-simulation-as-evaluation.md](references/progressive-deepening-mental-simulation-as-evaluation.md) — Progressive Deepening: Mental Simulation as the Evaluation Engine.
- [references/rpd-recognition-primed-decision-model.md](references/rpd-recognition-primed-decision-model.md) — The Recognition-Primed Decision Model: How Experts Actually Decide.
- [references/serial-evaluation-and-satisficing-under-time-pressure.md](references/serial-evaluation-and-satisficing-under-time-pressure.md) — Serial Evaluation and Satisficing: Why the First Good Answer Beats the Best Answer.
- [references/situation-assessment-as-primary-intelligence.md](references/situation-assessment-as-primary-intelligence.md) — Situation Assessment as Primary Intelligence: Why Knowing What's Happening Matters More Than Knowing What to Do.
