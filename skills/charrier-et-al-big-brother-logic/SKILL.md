...
> The distinction between distributed knowledge (D{a1,a2}φ) and common knowledge is essential here — see `references/distributed-vs-common-knowledge.md` for the formal treatment.
