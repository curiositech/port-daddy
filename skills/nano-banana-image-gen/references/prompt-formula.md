...
The **relationship instruction** is the structural part. It tells the model what role each reference plays. Without it, the model partly absorbs and partly ignores each reference, producing inconsistent output.
