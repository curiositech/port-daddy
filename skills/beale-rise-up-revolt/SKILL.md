...
metadata:
  ...
  io-contract:
    kind: none
    covers:
      - user empowerment and system accountability
      - internalized blame cycles in technology adoption
      - market dynamics of incremental vs. fundamental design improvement
      - consciousness-raising as infrastructure for UX progress
      - distributed network influence and cultural shift
      - HCI advocacy beyond designer education
