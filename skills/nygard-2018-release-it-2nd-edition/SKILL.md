...
- [diagrams/01_flowchart_failure_propagation_decision_t.md](diagrams/01_flowchart_failure_propagation_decision_t.md) — Failure Propagation Decision Tree.
- [diagrams/02_sequenceDiagram_cascading_failure_propagation_.md](diagrams/02_sequenceDiagram_cascading_failure_propagation_.md) — Cascading Failure Propagation Sequence.
- [diagrams/03_stateDiagram-v2_circuit_breaker_state_machine_.md](diagrams/03_stateDiagram-v2_circuit_breaker_state_machine_.md) — Circuit Breaker State Machine & Stability Pattern Lifecycle.
- [references/observability-feedback-loops.md](references/observability-feedback-loops.md) — Observability and the Decision-Making Feedback Loop.
