...
- [guides/ARTIFACT_PRESERVATION.md](guides/ARTIFACT_PRESERVATION.md) — Artifact Preservation Guide.
- [guides/ARTIFACT_QUICKREF.md](guides/ARTIFACT_QUICKREF.md) — Artifact Preservation Quick Reference.
- [references/artifact-structure.md](references/artifact-structure.md) — Artifact Structure Reference.
- [references/badge-metadata-management.md](references/badge-metadata-management.md) — Badge and Metadata Management Reference.
- [references/documentation-templates.md](references/documentation-templates.md) — Documentation Templates Reference.
- [scripts/validate-skills-sync.sh](scripts/validate-skills-sync.sh) — Validates that .claude/skills/ and website/docs/skills/ are in sync.
