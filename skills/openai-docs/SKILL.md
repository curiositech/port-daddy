...
- [agents/openai.yaml](agents/openai.yaml) — openai.yaml.
- [references/upgrade-guide.md](references/upgrade-guide.md) — Model upgrade guidance.
- [scripts/fetch-codex-manual.mjs](scripts/fetch-codex-manual.mjs) — fetch-codex-manual.mjs.
