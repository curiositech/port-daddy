...
- [references/animations-interactions.md](references/animations-interactions.md) — Animations & Micro-Interactions.
- [references/glassmorphism-patterns.md](references/glassmorphism-patterns.md) — Glassmorphism Patterns for SwiftUI.
- [references/metal-shaders.md](references/metal-shaders.md) — Metal Shaders for Vaporwave Effects.
- [references/vaporwave-aesthetic.md](references/vaporwave-aesthetic.md) — Vaporwave Aesthetic System.
