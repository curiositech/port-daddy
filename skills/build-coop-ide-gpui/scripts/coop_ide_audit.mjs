...
export function auditCoopIdeArchitecture(plan) {
  ...
  if (!surfaceComposesSiblings) {
    fail(
      ...
      'Compose the core siblings for this layer (rust-gpui-motion, gpui-shaders, vello-parley-rendering, metal-text-pipeline, gpui-rust-console) rather than rebuilding their concerns inline.'
    );
  }
