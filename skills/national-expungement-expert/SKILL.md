...
io-contract:
  kind: deliverable
  produces:
    - kind: eligibility-analysis
      description: >-
        State-specific expungement eligibility determination with offense type, waiting period calculation, and
        automatic vs. petition pathway identification
      format: markdown
    - kind: process-guide
      description: >-
        Step-by-step explanation of filing requirements, fees, timelines, and court procedures for the user's
        jurisdiction
      format: markdown
    - kind: alternative-options
      description: >-
        Fallback remedies (sealing, pardons, record restriction) when expungement is ineligible, with state-specific
        availability
      format: markdown
    - kind: misconception-correction
      description: >-
        Clarification of common false beliefs about expungement (federal vs. state, auto-clear myths, waiting period
        confusion)
      format: markdown
---
...
- [references/state-eligibility-matrix.md](references/state-eligibility-matrix.md) — State Eligibility Matrix.
