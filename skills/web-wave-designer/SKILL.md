...
- [references/animation-patterns.md](references/animation-patterns.md) — Animation Patterns for Water Effects.
- [references/displacement-and-color.md](references/displacement-and-color.md) — feDisplacementMap and Color Techniques for Water.
- [references/turbulence-deep-dive.md](references/turbulence-deep-dive.md) — feTurbulence Deep Dive for Water Effects.
