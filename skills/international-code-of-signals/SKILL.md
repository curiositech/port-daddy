...
description: >-
  ...
  (`task-analysis-of-pier-side-ship-handli`), radio hardware/frequency regulation, or palette work without signal
...
- Ship handling and maneuvering craft (`a-task-analysis-of-pier-side-ship-handli`).
