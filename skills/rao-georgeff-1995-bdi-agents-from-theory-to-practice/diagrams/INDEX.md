# Diagrams for rao-georgeff-1995-bdi-agents-from-theory-to-practice

**Primary Focus:** Architectural patterns for autonomous agents that balance real-time responsiveness with goal-directed planning under computational and environmental resource constraints.

## Generated Diagrams

1. **BDI Agent Decision Cycle: Belief-Desire-Intention State Machine** (stateDiagram-v2)
