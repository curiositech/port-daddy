...
io-contract:
  ...
  produces:
    - kind: documentation
      description: GOMS models, critical cue inventories, task decomposition hierarchies, decision trees
    - kind: analysis
      description: Expert task analysis results, capability mapping documentation, simulation/agent design specifications
metadata:
  recognition-cues: []
  expectancies: []
  decision-cues: []
