---
name: revisiting-interview-data-turn-taking
...
metadata:
  ...
  io-contract:
    kind: deliverable
    produces:
      - kind: methodology-framework
        description: >-
          Multi-layered analytical approach for revisiting qualitative interview data using stacked interpretive lenses
          (coding systems, cultural criteria, contextual background) without recollection
        format: markdown
      - kind: critique
        description: >-
          Assessment of single-framework analytical sufficiency, detection of hidden communicative breakdowns, and
          identification of power-differential distortions in interview data
        format: markdown
      - kind: refactor-plan
        description: >-
          Guidance on restructuring analytical workflows to preserve intermediate outputs as context assets, reframe
          primary-knower relationships, and apply selective a priori cultural foregrounding
        format: markdown
      - kind: interpretation-synthesis
        description: >-
          Reconciliation of contradictory readings across multiple frameworks with documented tensions treated as
...
- `references/asymmetry-status-and-the-pre-determined-interaction.md` — Examines how status asymmetry in structured interactions (interviews, classrooms, assessments) shapes what gets said and suppressed. **Read when** analyzing power dynamics in your data or detecting compliance masking disagreement.

- `references/coding-systems-and-the-limits-of-surface-analysis.md` — Explains why coding systems are necessary but insufficient for discourse analysis; they capture surface patterns but miss illocutionary intent. **Read when** your coded output seems suspiciously clean or you suspect hidden breakdowns.

- `references/communicative-breakdown-as-primary-data.md` — Inverts standard analysis: treats breakdown moments as informationally rich rather than noise. **Read when** you need to identify what topics or contexts trigger communication failure.

- `references/contingency-and-formality-in-structured-exchanges.md` — Maps the spectrum from casual to formal interaction; explains how pre-allocated turns constrain what participants can say. **Read when** designing or analyzing structured interviews or institutional exchanges.

- `references/cultural-context-as-active-analytical-tool.md` — Shows how to foreground cultural context as an interpretive layer rather than background; avoids both over-imposition and analytical blindness. **Read when** working across cultural contexts and unsure whether to apply cultural criteria a priori.

- `references/cultural-criteria-and-avoiding-anglocentric-evaluation.md` — Identifies the danger of implicit Western evaluation frameworks; proposes culture-specific criteria for assessing discourse quality. **Read when** analyzing non-Western participants or detecting evaluative bias in your framework.

- `references/emergent-research-and-data-revisitation.md` — Establishes data revisitation as legitimate research strategy; data collected for one purpose contains latent information explorable for others. **Read when** deciding whether to re-analyze existing transcripts or logs with new tools.

- `references/hidden-breakdown-and-face-sensitive-communication.md` — Explains why face-sensitive, high power-distance contexts hide breakdowns; surface coding misses the most significant failures. **Read when** analyzing intercultural or hierarchical interactions where participants may suppress disagreement.

- `references/layers-of-insight-as-analytical-methodology.md` — Demonstrates stacking multiple frameworks (IRF coding, moves/acts, cultural criteria, context) over same data without premature synthesis. **Read when** applying the core skill methodology to your own analysis.

- `references/layers-of-insight-multi-tool-interpretation.md` — Explains how to use multiple frameworks simultaneously without collapsing them into one account; each layer reveals what others cannot. **Read when** you have contradictory readings and need to preserve tensions as findings.

- `references/multi-purpose-data-and-the-ethics-of-inference.md` — Addresses ethical complexity of analyzing data for purposes beyond original consent; proposes honest handling of secondary inference. **Read when** repurposing interview or observational data for unplanned analytical goals.

- `references/primary-knower-inversion-and-role-contamination.md` — Identifies how research interviews invert classroom roles (student becomes primary knower) and how this role shift affects interaction quality and interpretation. **Read when** analyzing interviews with participants who hold specialized knowledge or experience.

- `references/repair-sequences-as-diagnostic-windows.md` — Treats repair (correction, clarification) as diagnostic of interaction quality rather than noise; shows what breakdown patterns reveal. **Read when** examining where and how participants signal or suppress misunderstanding.

- `references/surface-coding-vs-illocutionary-intent.md` — Documents the gap between what surface features show and what speakers actually intend; false positives, face-saving, suppressed breakdowns. **Read when** your coded patterns contradict your intuition about what was really happening.

- `references/the-methodology-of-revisiting-data.md` — Explains how returning to data with new tools yields different findings; revisitation is not re-reading but analytical re-encounter. **Read when** planning a multi-pass analytical workflow or justifying return to existing data.

- `references/the-researcher-as-instrument-and-source-of-bias.md` — Establishes researcher as unavoidable participant in interview data; proposes self-awareness rather than elimination of influence. **Read when** assessing your own role in shaping participant responses or detecting interviewer bias.

- `references/the-semi-structured-approach-to-complex-inquiry.md` — Contrasts fully structured (fixed questions, fixed order) with semi-structured (flexible follow-up); explains why flexibility captures emergent information. **Read when** designing interview protocols or evaluating whether your data collection method constrained discovery.
