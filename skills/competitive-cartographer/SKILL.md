...
### Evidence before white space

For every competitor cell, record the customer job, substitute, official source
URL and access date, observed capability, evidence depth, and `unknown` where
verification is absent. An empty cell means “not established,” never “nobody
does this.” A viable opportunity needs a customer need, feasible delivery path,
and kill test that would disconfirm it. Compare the strongest credible substitute
before recommending differentiation. See `references/verified-opportunity-map.md`.
