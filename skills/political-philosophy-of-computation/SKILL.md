...
description: >
  Applies political philosophy frameworks (Hobbes, Locke, Rousseau, Rawls, Sen, Ostrom) to software architecture
  decisions -- authority models, resource allocation, capability assignment, and commons governance. NOT FOR general
  philosophy courses, ethics of AI alignment, trolley problems, or moral philosophy of consciousness.
metadata:
  ...
  io-contract:
    ...
    produces:
      - kind: design-doc
        description: >-
          Political philosophy framework applied to a specific architecture decision (e.g., centralized vs. distributed
          authority, capability assignment, resource allocation governance)
        format: markdown
      - kind: critique
        description: >-
          Analysis of an existing system design through the lens of Hobbes, Locke, Rousseau, Rawls, Sen, or Ostrom,
          identifying tensions and tradeoffs
        format: markdown
      - kind: refactor-plan
        description: >-
          Concrete recommendations to shift a system's authority model, consent mechanism, or commons governance toward
          a different political philosophy framework
        format: markdown
...
- `diagrams/01_flowchart_decision-points.md` — Mermaid flowchart routing requests to appropriate political philosophy framework (Hobbes, Locke, Rousseau, Rawls, Sen, Ostrom). **Read when** deciding which thinker's lens applies to your architecture problem.
...
**Skill Evaluations:** See [`evals/evals.json`](evals/evals.json) for benchmark prompts and expected outputs used to validate this skill on authority-model and commons-governance design reviews.
