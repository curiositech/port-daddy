...
- [references/automation-surprises-and-failure-mode-prevention.md](references/automation-surprises-and-failure-mode-prevention.md) — Automation Surprises and Failure Mode Prevention in Complex Cognitive Systems.
- [references/cognitive-work-analysis-as-constraint-mapping.md](references/cognitive-work-analysis-as-constraint-mapping.md) — Cognitive Work Analysis: Mapping Constraints That Define the Solution Space.
- [references/design-as-dialog-not-sequence.md](references/design-as-dialog-not-sequence.md) — Design as Dialog: Why Sequential Process Models Fail Complex Problems.
- [references/expert-models-as-engineering-blueprints.md](references/expert-models-as-engineering-blueprints.md) — Expert Models as Engineering Blueprints: How Exceptional Performance Specifies System Requirements.
- [references/invisible-cognitive-layer-in-system-design.md](references/invisible-cognitive-layer-in-system-design.md) — The Invisible Cognitive Layer: What Engineers Systematically Miss.
- [references/joint-cognitive-systems-and-distributed-cognition.md](references/joint-cognitive-systems-and-distributed-cognition.md) — Joint Cognitive Systems: Why the Unit of Analysis Must Be the Whole, Not the Parts.
- [references/problem-framing-as-the-critical-design-act.md](references/problem-framing-as-the-critical-design-act.md) — Problem Framing as the Critical Design Act: Why Solving the Wrong Problem Is the Primary Failure Mode.
- [references/value-of-cse-to-stakeholders-making-the-invisible-visible.md](references/value-of-cse-to-stakeholders-making-the-invisible-visible.md) — Making the Invisible Visible: How to Justify What Can't Easily Be Measured.
