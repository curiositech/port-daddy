...
- **Rule numbering reconciled, and now discharged.** This skill's typographic-law rules were P15–P17; thirty
  ...
  On `claude/book-maximal-apparatus` both branches are in one file, so the reservation is
  discharged: P15–P17 and P18–P25 are all implemented here and `RESERVED_RULE_IDS` is empty.
