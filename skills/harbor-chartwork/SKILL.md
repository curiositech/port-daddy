...
`tests/test_tikz_precheck_typography.py` covers the typographic-law rules P18–P24, the apparatus-prefix rule and the rule-id registry; `tests/test_figcheck_typeface.py` covers T9, T10 and the font-family helpers — a passing
