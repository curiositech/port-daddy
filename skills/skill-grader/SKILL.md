...
## Structural quality versus efficacy

This rubric grades the skill artifact, not whether it improves agent performance. Never turn an A grade into an efficacy claim. For causal evaluation, load `references/efficacy-evaluation.md`; report structural and outcome evidence separately.
