# Technical Evangelism For Formal Systems — Changelog
...
## 2026-04-20
- Shortened the description, strengthened activation keywords, and kept explicit `NOT for` boundaries
- Split body guidance into `When to Use` and `NOT for Boundaries` sections for clearer routing
- Moved the detailed Leviathan worked example into `references/leviathan-blog-outline.md` so the core skill stays lean
