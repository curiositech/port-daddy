  ...
  io-contract:
    ...
    produces:
      - kind: skill-search-results
        description: Candidate installable skills, install commands, and links matched to the user's requested capability
        format: markdown
      - kind: installation-guidance
        description: Short instructions for adding or evaluating a selected skill
        format: markdown
---
