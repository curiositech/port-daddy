...
- [references/decisions-about-behavior-the-hardest-domain.md](references/decisions-about-behavior-the-hardest-domain.md) — Decisions About Behavior: The Hardest Prediction Problem in Expert Decision-Making.
- [references/expert-novice-gap-in-situation-assessment.md](references/expert-novice-gap-in-situation-assessment.md) — The Expert-Novice Gap: Why Experts See Differently, Not Just Better.
- [references/expert-vs-novice-decision-signatures.md](references/expert-vs-novice-decision-signatures.md) — The Novice-to-Expert Arc: Decision Signatures at Each Stage and What They Mean for Agent Development.
- [references/failure-modes-in-high-stakes-dynamic-systems.md](references/failure-modes-in-high-stakes-dynamic-systems.md) — Failure Modes in High-Stakes Dynamic Systems: What Goes Wrong and Why.
- [references/failure-modes-plan-fixation-and-update-failure.md](references/failure-modes-plan-fixation-and-update-failure.md) — The Most Dangerous Failure Mode: When Good Plans Become Wrong Plans.
- [references/recognition-primed-decision-making-for-agents.md](references/recognition-primed-decision-making-for-agents.md) — Recognition-Primed Decision Making: How Experts Bypass Deliberation (And How Agents Should Too).
- [references/recognition-primed-decision-making.md](references/recognition-primed-decision-making.md) — Recognition-Primed Decision Making: How Experts Skip the Comparison Step.
- [references/satisficing-and-the-quick-test.md](references/satisficing-and-the-quick-test.md) — Satisficing and the Quick Test: How Intelligent Systems Should Decide When to Think and When to Act.
- [references/situation-assessment-as-the-critical-skill.md](references/situation-assessment-as-the-critical-skill.md) — Situation Assessment as the Core Competency: Why Getting the Picture Right Matters More Than Choosing the Right Action.
- [references/situation-awareness-decomposition-and-coordination.md](references/situation-awareness-decomposition-and-coordination.md) — Situation Awareness, Problem Decomposition, and Coordination Without Full Understanding.
- [references/tacit-knowledge-elicitation-and-the-cdm.md](references/tacit-knowledge-elicitation-and-the-cdm.md) — Extracting What Experts Can't Tell You: The Critical Decision Method and Tacit Knowledge.
- [references/tacit-knowledge-elicitation-for-agent-knowledge-bases.md](references/tacit-knowledge-elicitation-for-agent-knowledge-bases.md) — Eliciting Tacit Expert Knowledge: The CDM Method and Its Application to Building Agent Knowledge Bases.
- [references/ten-characteristics-of-naturalistic-decision-environments.md](references/ten-characteristics-of-naturalistic-decision-environments.md) — The Ten Characteristics of Naturalistic Decision Environments and Their Agent System Implications.
- [references/the-three-pronged-framework-observation-interview-training.md](references/the-three-pronged-framework-observation-interview-training.md) — The Three-Pronged Framework: How to Observe, Understand, and Improve Complex Decision Processes.
- [references/training-for-expertise-deliberate-practice-and-the-experience-bank.md](references/training-for-expertise-deliberate-practice-and-the-experience-bank.md) — Training for Expertise: Building the Mental Models That Enable Expert Decision-Making.
- [references/uncertainty-acceptance-and-information-seeking.md](references/uncertainty-acceptance-and-information-seeking.md) — Uncertainty Acceptance and Strategic Information Seeking: How Expert Systems Operate Without Complete Information.
