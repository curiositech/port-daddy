...
For system claims, keep a source ledger and distinguish proof, finite model checking, simulation, sampled LLM evaluation, and production witnesses. Load `references/evidence-ledger.md`; do not describe one class as another.
