...
- [diagrams/01_flowchart_naturalistic_insight_decision_.md](diagrams/01_flowchart_naturalistic_insight_decision_.md) — Naturalistic Insight Decision Tree.
- [diagrams/02_stateDiagram-v2_insight_pathway_activation_&_a.md](diagrams/02_stateDiagram-v2_insight_pathway_activation_&_a.md) — Insight Pathway Activation & Anchor Revision.
- [diagrams/03_quadrantChart_insight_mechanism_selection_ma.md](diagrams/03_quadrantChart_insight_mechanism_selection_ma.md) — Insight Mechanism Selection Matrix.
- [references/contradiction-driven-insight-pathways.md](references/contradiction-driven-insight-pathways.md) — Contradiction-Driven Insight: When Weak Anchors Become Breakthroughs.
- [references/expertise-enables-insight-not-fixation.md](references/expertise-enables-insight-not-fixation.md) — Expertise as Enabler: Why Mental Set Theory Misguides Agent Design.
- [references/gradual-insight-and-pattern-accumulation.md](references/gradual-insight-and-pattern-accumulation.md) — Gradual Insight: When Breakthroughs Emerge Without "Aha!" Moments.
- [references/organizational-barriers-to-insight.md](references/organizational-barriers-to-insight.md) — The Asymmetric War: Why Organizations Excel at Error Prevention But Fail at Insight Promotion.
- [references/task-decomposition-for-insight-vs-execution.md](references/task-decomposition-for-insight-vs-execution.md) — Task Decomposition for Insight vs. Execution: A Fundamental Distinction.
- [references/three-pathways-anchor-model.md](references/three-pathways-anchor-model.md) — The Anchor Model: Three Distinct Pathways to Insight.
- [references/when-error-prevention-blocks-insight.md](references/when-error-prevention-blocks-insight.md) — When Error Prevention Blocks Insight: The Documentation Trap and Proceduralization Paradox.
