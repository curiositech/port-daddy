...
- [agents/analyzer.md](agents/analyzer.md) — Analyzer Agent.
- [agents/comparator.md](agents/comparator.md) — Blind Comparator Agent.
- [agents/grader.md](agents/grader.md) — Grader Agent.
- [eval-viewer/generate_review.py](eval-viewer/generate_review.py) — Files to exclude from output listings.
- [references/description-optimization.md](references/description-optimization.md) — Description Optimization: Detailed Guide.
- [references/eval-patterns.md](references/eval-patterns.md) — Eval Assertion Patterns.
...
- [scripts/__init__.py](scripts/__init__.py) — __init__.py.
- [scripts/aggregate_benchmark.py](scripts/aggregate_benchmark.py) — aggregate_benchmark.py.
- [scripts/generate_report.py](scripts/generate_report.py) — generate_report.py.
- [scripts/improve_description.py](scripts/improve_description.py) — improve_description.py.
- [scripts/package_skill.py](scripts/package_skill.py) — Patterns to exclude when packaging skills..
- [scripts/quick_validate.py](scripts/quick_validate.py) — quick_validate.py.
- [scripts/run_eval.py](scripts/run_eval.py) — run_eval.py.
- [scripts/run_loop.py](scripts/run_loop.py) — run_loop.py.
- [scripts/utils.py](scripts/utils.py) — utils.py.
