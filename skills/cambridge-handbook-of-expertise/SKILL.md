...
metadata:
  ...
  io-contract:
    kind: none
    covers:
      - Expert knowledge elicitation methodologies
...
- `diagrams/01_flowchart_knowledge_elicitation_method_s.md` — Decision tree for selecting elicitation methods by primary goal. **Read when** choosing which technique fits your knowledge capture objective.
...
- `references/scaffolding-over-extraction.md` — Critique of extraction metaphor; scaffolded collaboration model for elicitation. **Read when** planning expert interviews or overcoming articulation barriers.

- `references/the-gold-not-in-documents.md` — Why documented procedures miss tacit expertise; undocumented "true work" concept. **Read when** investigating gaps between official procedures and actual expert performance.

- `references/expertise-beyond-procedures.md` — Procedure paradox: why SOPs alone fail to capture expert reasoning. **Read when** building training systems or understanding failure in complex sociotechnical systems.

- `references/elicitation-as-collaborative-discovery.md` — Paradigm shift from extraction to co-construction in knowledge elicitation. **Read when** designing human-agent collaboration or knowledge preservation initiatives.

- `references/differential-utility-method-selection.md` — Empirical findings on method selection; differential access hypothesis critique. **Read when** choosing between competing elicitation techniques for your domain.

- `references/proactive-knowledge-preservation.md` — Ongoing organizational practice vs. one-time extraction; knowledge evolution. **Read when** designing sustainable knowledge preservation strategy for organizational change.
