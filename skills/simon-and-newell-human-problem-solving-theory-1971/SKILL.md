...
- [references/serial-processing-constraints-shape-behavior.md](references/serial-processing-constraints-shape-behavior.md) — How Serial Processing and Memory Limits Shape Problem-Solving Behavior.
- [references/structure-exploitation-over-search-power.md](references/structure-exploitation-over-search-power.md) — Structure Exploitation: The Real Source of Problem-Solving Power.
- [references/task-environment-vs-problem-space.md](references/task-environment-vs-problem-space.md) — Task Environment vs. Problem Space: The Representation Problem.
