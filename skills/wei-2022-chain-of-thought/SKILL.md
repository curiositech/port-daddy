...
- [diagrams/01_flowchart_task_decomposition_decision_tr.md](diagrams/01_flowchart_task_decomposition_decision_tr.md) — Task Decomposition Decision Tree.
- [diagrams/02_sequenceDiagram_multi-agent_reasoning_coordina.md](diagrams/02_sequenceDiagram_multi-agent_reasoning_coordina.md) — Multi-Agent Reasoning Coordination Protocol.
- [diagrams/03_quadrantChart_task_complexity_vs._agent_capa.md](diagrams/03_quadrantChart_task_complexity_vs._agent_capa.md) — Task Complexity vs. Agent Capability: Decomposition Strategy Matrix.
- [references/emergent-capabilities-and-decomposition-thresholds.md](references/emergent-capabilities-and-decomposition-thresholds.md) — Emergent Capabilities and Decomposition Thresholds in Intelligent Systems.
- [references/model-scale-agent-capability-and-coordination.md](references/model-scale-agent-capability-and-coordination.md) — Model Scale, Agent Capability, and the Economics of Coordination.
- [references/natural-language-reasoning-in-agent-coordination.md](references/natural-language-reasoning-in-agent-coordination.md) — Natural Language as Reasoning Medium: Why It Works and When to Use It.
- [references/prompt-engineering-robustness-and-brittleness.md](references/prompt-engineering-robustness-and-brittleness.md) — Prompt Engineering: Robustness, Brittleness, and What Matters for Production Systems.
- [references/reasoning-failure-modes-and-recovery.md](references/reasoning-failure-modes-and-recovery.md) — Reasoning Failure Modes and Recovery Strategies in Multi-Step Problem Solving.
- [references/variable-compute-and-structured-reasoning.md](references/variable-compute-and-structured-reasoning.md) — Variable Compute Allocation Through Structured Reasoning.
- [references/when-decomposition-helps-and-when-it-hurts.md](references/when-decomposition-helps-and-when-it-hurts.md) — When Decomposition Helps and When It Hurts: The Complexity-Capability Matching Problem.
