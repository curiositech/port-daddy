...
- [references/frame-elaboration-vs-frame-comparison.md](references/frame-elaboration-vs-frame-comparison.md) — Frame Elaboration vs. Frame Comparison: Managing Cognitive Commitment in Uncertain Situations.
- [references/sensemaking-decision-making-separation.md](references/sensemaking-decision-making-separation.md) — Sensemaking-Decision-Making Separation: Why Experts Keep These Processes Distinct.
- [references/sensemaking-triggers-and-anomaly-detection.md](references/sensemaking-triggers-and-anomaly-detection.md) — Sensemaking Triggers and Anomaly Detection: When Does Deliberate Understanding Begin?.
