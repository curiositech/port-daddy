...
- [diagrams/01_flowchart_mape-k_feedback_loop_architect.md](diagrams/01_flowchart_mape-k_feedback_loop_architect.md) — MAPE-K Feedback Loop Architecture.
- [diagrams/02_stateDiagram-v2_hierarchical_feedback_loop_lay.md](diagrams/02_stateDiagram-v2_hierarchical_feedback_loop_lay.md) — Hierarchical Feedback Loop Layers.
- [diagrams/03_quadrantChart_system_adaptation_complexity_v.md](diagrams/03_quadrantChart_system_adaptation_complexity_v.md) — System Adaptation Complexity vs. Formality Trade-off.
- [references/control-theory-for-software.md](references/control-theory-for-software.md) — Control Theory for Software Adaptation: Automatic Controller Synthesis.
- [references/formal-adaptation-goals.md](references/formal-adaptation-goals.md) — Formal Adaptation Goals: Making Requirements Executable.
- [references/hierarchical-feedback-loops.md](references/hierarchical-feedback-loops.md) — Hierarchical Feedback Loops: Scaling Self-Adaptation to Complex Systems.
- [references/managed-vs-managing-separation.md](references/managed-vs-managing-separation.md) — The Fundamental Architecture: Managed vs. Managing Systems.
