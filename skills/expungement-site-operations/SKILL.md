...
io-contract:
  ...
  produces:
    - kind: documentation
      description: Operational decision matrices and workflow documentation for expungement SaaS systems
    - kind: architecture-guide
      description: User intake flows, document generation pipelines, and attorney assignment logic
    - kind: configuration
      description: State-specific rules matrices and failure mode remediation procedures
---
