...
- [references/animation-patterns.md](references/animation-patterns.md) — Cloud Animation Patterns.
- [references/color-and-lighting.md](references/color-and-lighting.md) — Cloud Color and Lighting Guide.
- [references/svg-filter-deep-dive.md](references/svg-filter-deep-dive.md) — SVG Filter Deep Dive for Cloud Effects.
