...
**Decision Point — barrel BEFORE you sample, CA AT sample, scanlines AFTER.** The order is foundational: distort UVs, fetch the three channels, *then* multiply the line/grille mask onto the fetched color. Scanline-then-distort smears the lines into the curve.
