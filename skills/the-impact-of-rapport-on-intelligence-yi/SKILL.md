...
- [references/attention-as-the-primary-yield-driver.md](references/attention-as-the-primary-yield-driver.md) — Attention as the Primary Yield Driver: What Active Listening Actually Requires.
- [references/coordination-as-structural-intelligence.md](references/coordination-as-structural-intelligence.md) — Coordination as Structural Intelligence: What Process Clarity Does That Social Warmth Cannot.
- [references/frequency-impact-asymmetry-in-skilled-performance.md](references/frequency-impact-asymmetry-in-skilled-performance.md) — The Frequency-Impact Asymmetry: Why What Practitioners Do Most Is Not What Works Best.
- [references/frequency-monitoring-as-quality-control.md](references/frequency-monitoring-as-quality-control.md) — Frequency Monitoring as Quality Control: How Counting Specific Behaviors Provides Better Feedback Than Holistic Ratings.
- [references/informal-vs-formal-interaction-elicitation-context-matters.md](references/informal-vs-formal-interaction-elicitation-context-matters.md) — Context Shapes Elicitation: How Formal vs. Informal Settings Change What Rapport Components Are Available and Effective.
- [references/motivation-as-functional-intelligence.md](references/motivation-as-functional-intelligence.md) — Motivation as Functional Intelligence: Why Understanding Why Someone Shares Changes How You Elicit.
- [references/objective-measurement-vs-subjective-rating.md](references/objective-measurement-vs-subjective-rating.md) — Objective Behavioral Measurement vs. Subjective Rating: Why the Measurement Choice Changes What You Can Learn.
- [references/rapport-decomposition-and-differential-impact.md](references/rapport-decomposition-and-differential-impact.md) — Rapport Decomposition: Why Disaggregating a Complex Construct Reveals What Actually Works.
- [references/self-report-vs-behavior-gap.md](references/self-report-vs-behavior-gap.md) — The Self-Report / Behavior Gap: Why Systems Cannot Monitor Themselves Through Self-Assessment.
- [references/working-alliance-vs-social-warmth.md](references/working-alliance-vs-social-warmth.md) — Working Alliance vs. Social Warmth: The Definitional Choice That Determines What Gets Built.
