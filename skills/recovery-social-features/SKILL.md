...
io-contract:
  ...
  produces:
    - kind: design-doc
      description: >-
        Privacy-first social architecture for recovery apps covering sponsor/sponsee systems, group creation, messaging
        safety, and accountability sharing with decision trees and failure mode mitigations
      format: markdown
    - kind: refactor-plan
      description: >-
        Guidance for retrofitting existing social features into recovery-safe patterns, including privacy reset
        procedures, group size management, and crisis detection integration
      format: markdown
    - kind: critique
      description: >-
        Safety and privacy review of proposed social feature implementations against recovery-specific risks (overshare,
        group overrun, sponsor abuse, identity leaks)
      format: markdown
---
...
- [references/accountability.md](references/accountability.md) — Accountability Features.
- [references/friendships.md](references/friendships.md) — Friend Connections.
- [references/groups.md](references/groups.md) — Meeting-Based Groups.
- [references/messaging.md](references/messaging.md) — Safe Messaging.
- [references/moderation.md](references/moderation.md) — Safety & Moderation.
- [references/sponsor-sponsee.md](references/sponsor-sponsee.md) — Sponsor/Sponsee Implementation.
