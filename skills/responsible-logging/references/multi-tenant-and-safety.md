# Two Horizons: Correlation Ids + Observability-as-Auxiliary
...
## Observability must never be pivotal for liveness
...
still processes requests.* If it can't, observability is central and must be fixed.
