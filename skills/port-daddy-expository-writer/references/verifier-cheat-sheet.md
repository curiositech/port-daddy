...
For deeper reference (input/output shapes, known-good idioms, integration patterns), see `port-daddy/skills/redteam-review/references/computational-tooling.md`. That file is the operator's foundational reference for which verifier fits which problem.
