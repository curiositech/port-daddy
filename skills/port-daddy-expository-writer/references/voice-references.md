...
- **"Naively"** as a technical adjective — borderline. *"The naive expected-value calculation"* (from the paper) is fine because *naive* is a decisive word in mechanism design. *"Naively one might think..."* as a rhetorical device is not.
