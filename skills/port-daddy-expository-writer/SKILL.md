...
- **The whitepaper itself.** The paper is the structural artifact; the expository piece *explains* the paper. Don't try to write the paper inside `docs/concepts/`.
...
- `agents/expositor-fact-checker.md` — third-pass persona; reads the original paper alongside the expository version and confirms the pivotal claims survived translation.
