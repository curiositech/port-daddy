...
- [schemas/skill-selector-output.schema.json](schemas/skill-selector-output.schema.json) — skill-selector-output.schema.json.
- [templates/skill-selector-output.template.json](templates/skill-selector-output.template.json) — skill-selector-output.template.json.
