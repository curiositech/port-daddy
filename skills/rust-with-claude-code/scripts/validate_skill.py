#!/usr/bin/env python3
"""Self-check the rust-with-claude-code skill: frontmatter, required references,
...
REQUIRED_SCRIPTS_SELFTEST = ["cargo_diagnostics.py"]
REQUIRED_TEMPLATES = ["ffi_export.rs.tmpl", "async_pane_test.rs.tmpl"]
REQUIRED_EXAMPLES = ["fix-a-borrow-error.md", "add-an-ffi-export.md"]
