...
- [references/investment-theory.md](references/investment-theory.md) — Investment Theory.
- [references/tax-optimization.md](references/tax-optimization.md) — Tax Optimization Strategies.
- [references/withdrawal-math.md](references/withdrawal-math.md) — Withdrawal Mathematics.
