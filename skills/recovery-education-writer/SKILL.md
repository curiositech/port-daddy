...
io-contract:
  kind: deliverable
  produces:
    - kind: psychoeducational-article
      description: >-
        Peer-oriented educational content explaining addiction/recovery phenomena through neuroscience, structured as:
        vulnerability hook → mechanism explanation → recovery timeline → shame normalization → actionable steps
      format: markdown
    - kind: harm-reduction-guide
      description: >-
        Accessible explanation of drug effects, withdrawal syndromes, or recovery challenges rooted in brain/body
        mechanisms with concrete coping strategies
      format: markdown
    - kind: recovery-science-explainer
      description: >-
        Translation of neuroscientific research (neuroplasticity, dopamine dysregulation, PAWS, etc.) into
        lived-experience language that validates and demystifies
      format: markdown
---
