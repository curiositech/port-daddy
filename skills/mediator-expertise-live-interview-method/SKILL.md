---
name: mediator-expertise-live-interview-method
...
metadata:
  ...
  io-contract:
    ...
    produces:
      - kind: methodology
        description: >-
          Systematic protocol for designing and conducting expert knowledge elicitation interviews that surface tacit
          practitioner expertise below conscious articulation
        format: markdown
      - kind: interview-guide
        description: >-
          Structured question sequences and re-evocation prompts tailored to a specific expert domain, designed to
          bypass curated narratives and access recognition-primed decision patterns
        format: markdown
      - kind: knowledge-transfer-plan
        description: >-
          Actionable design for capturing, documenting, and transferring elicited tacit expertise to training curricula,
          AI models, or successor practitioners
        format: markdown
      - kind: critique
        description: >-
          Assessment of knowledge withholding dynamics, expertise-experience gaps, and contextual transfer risks in a
          specific professional community or knowledge capture initiative
        format: markdown
---
...
- `references/communities-of-practice-as-knowledge-infrastructure.md` — Defines CoP as epistemic unit where tacit knowledge lives and transfers. **Read when** designing knowledge capture or diagnosing why professional communities fail to learn.
- `references/community-of-practice-design-for-agent-coordination.md` — CoP framework applied to informal practice-centered social structures. **Read when** understanding how professional knowledge actually transmits without central control.
- `references/decision-making-under-uncertainty-the-expert-pattern.md` — Critiques standard rational choice model; explains how experts actually decide. **Read when** modeling expert judgment or designing interview prompts for decision-making.
- `references/deliberate-practice-and-agent-capability-development.md` — Ericsson's 10-year threshold and structure of expertise development. **Read when** evaluating claimed expertise or designing training curricula.
- `references/elicitive-methodology-local-over-universal-knowledge.md` — Lederach's critique of culturally embedded training; why local knowledge beats universal frameworks. **Read when** transferring expertise across contexts or cultures.
- `references/expertise-as-domain-specific-not-general.md` — Domain-specificity principle and implications for agent routing. **Read when** assessing whether expertise transfers or designing specialist systems.
- `references/expertise-is-not-experience-the-deliberate-practice-gap.md` — Distinguishes experience from expertise; exposes tenure-as-competence fallacy. **Read when** evaluating practitioner credentials or identifying knowledge withholding.
- `references/four-passes-framework-for-deep-cognitive-inquiry.md` — Staged protocol for accessing expert cognition; Klein's structured inquiry method. **Read when** designing interview sequences or conducting knowledge elicitation.
- `references/knowledge-transfer-failure-modes.md` — Systematic barriers preventing expert knowledge from reaching those who need it. **Read when** diagnosing why knowledge capture initiatives fail.
- `references/metacognition-and-reflection-before-during-after.md` — Schön's reflective practice; what reflection actually requires in expert work. **Read when** designing reflection prompts or understanding expert self-awareness gaps.
- `references/naturalistic-decision-making-and-pattern-recognition.md` — Klein's research on expert decision-making under time pressure; pattern recognition over option enumeration. **Read when** extracting recognition-primed decisions or modeling expert judgment.
- `references/structural-barriers-to-knowledge-transfer.md` — Why CPD and professional learning structures systematically prevent knowledge transfer. **Read when** understanding institutional obstacles to expertise elicitation.
- `references/tacit-expertise-elicitation-protocol.md` — Core problem: expertise lives below conscious access; Nisbett & Wilson on introspective access limits. **Read when** designing prompts to surface tacit knowledge.
- `references/tacit-knowledge-elicitation-protocols.md` — Why experts are poor at describing their own expertise; gap between knowing and telling. **Read when** planning interview strategy or re-evocation techniques.
- `references/the-credential-expertise-gap-and-routing.md` — Certification doesn't signal competence; credential-expertise mismatch in mediation. **Read when** evaluating claimed expertise or routing to genuine practitioners.
- `references/the-war-story-problem-authentic-vs-curated-knowledge.md` — War stories as corrupted knowledge artifacts; how to extract authentic practice. **Read when** distinguishing rehearsed narratives from real expertise.
- `references/theory-in-use-vs-theory-espoused.md` — Argyris & Schön gap between declared strategy and actual practice. **Read when** designing interview questions to bypass official accounts.
