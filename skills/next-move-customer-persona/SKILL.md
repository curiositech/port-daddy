...
io-contract:
  ...
  produces:
    - kind: analysis
      description: Customer persona research and positioning guidance for /next-move including target personas (ADHD developers, project leads, indie hackers), messaging frameworks, pain point mapping, and competitive differentiation.
---
