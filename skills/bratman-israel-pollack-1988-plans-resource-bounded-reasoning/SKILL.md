...
description: >-
  Use for bounded reasoning, partial planning, commitment policy, deliberation cost, and reconsideration-threshold
  design instead of assuming free deliberation. NOT for exhaustive planning, static optimization, or domains where
  reconsideration cost is irrelevant.
license: Apache-2.0
...
metadata:
  ...
  io-contract:
    ...
    produces:
      - kind: design-doc
        description: >-
          commitment structure and override policy for a resource-bounded planner, including which decisions to fix now,
          which to defer, and explicit reconsideration triggers
        format: markdown
      - kind: critique
        description: >-
          diagnosis of planning failure modes (premature commitment, thrashing reconsideration, brittle inflexibility,
          or premature refinement) and repair strategy
        format: markdown
      - kind: refactor-plan
        description: >-
          conversion of an idealized planner into a bounded-reasoning agent by pricing deliberation cost, adding partial
          commitments, and tuning override thresholds
        format: markdown
---
