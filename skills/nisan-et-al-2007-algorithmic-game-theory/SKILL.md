...
io-contract:
  ...
  covers:
    ...
    - strategic behavior in computational systems
---
...
Deep-dive reference chapters bundled with this skill:

- **references/mechanism-design-with-money.md** — VCG mechanisms, auctions, incentive-compatible payment rules.
- **references/equilibrium-computation-and-convergence.md** — computing Nash equilibria, complexity (PPAD), learning dynamics and when they converge.
- **references/price-of-anarchy-and-network-design.md** — bounding efficiency loss from selfish behavior; routing and network-formation games.
- **references/reputation-systems-and-trust.md** — reputation as an incentive instrument; whitewashing, Sybil attacks, and trust aggregation.
- **references/information-aggregation-and-prediction.md** — prediction markets, scoring rules, and eliciting honest beliefs.

(`_book_identity.json` and `_raw_response.md` are book-skill generation artifacts, consistent with the other imported-literature bundles.)
