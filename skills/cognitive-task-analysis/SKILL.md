...
io-contract:
  ...
  produces:
    - kind: analysis
      description: Knowledge elicitation findings and expert cognitive process maps
    - kind: documentation
      description: Methodology documentation and knowledge base design recommendations
metadata:
  recognition-cues: []
  expectancies: []
  decision-cues: []
