...
export async function handleSpawn(
  ...
  const validBackends = ['ollama', 'claude', 'claude-cli', 'gemini', 'cloudflare', 'openai', 'groq', 'codex', 'aider', 'custom', 'cli:claude-code', 'cli:codex'];
  ...
  if (!task) {
    ...
    console.error('');
    console.error('Backends: ollama, claude, claude-cli, gemini, cloudflare, openai, groq, codex, aider, custom, cli:claude-code, cli:codex');
    console.error('');
