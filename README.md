...
- [Editor reload preservation](docs/research/egosystem-reconciliation/final/cooperative-editor-reload-evidence.md) — refused or failed reloads retain the live editor, including imported operations waiting for dependencies. This protects in-memory work; disk saving and crash-safe private drafts remain open.
