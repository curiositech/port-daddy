...
- [Editor reload preservation](docs/research/egosystem-reconciliation/final/cooperative-editor-reload-evidence.md) — refused or failed reloads retain the live editor, including imported operations waiting for dependencies. This protects in-memory work; crash-safe private drafts remain open.
- [Local editor save evidence](docs/research/egosystem-reconciliation/final/cooperative-editor-save-evidence.md) — explicit revision-bound local text saving, optimistic disk-conflict checks and metadata preservation/refusal. Later edits remain dirty; saving text is not shared acceptance or durable CRDT recovery. Native interaction proof remains open.
