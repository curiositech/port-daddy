...
const skillSource = (path: string) => repo(path)
        ...
        citations: [
          {
            ...
            skillDossiers: [skillSource('skills/multi-agent-coordination/SKILL.md'), skillSource('skills/agent-conversation-protocols/SKILL.md')],
          },
          {
            ...
            skillDossiers: [skillSource('skills/multi-agent-coordination/SKILL.md'), skillSource('skills/ipc-communication-patterns/SKILL.md')],
          },
          {
            ...
            skillDossiers: [skillSource('skills/agent-conversation-protocols/SKILL.md'), skillSource('skills/ipc-communication-patterns/SKILL.md')],
          },
          {
            title: 'Tuple space',
          ...
          },
          {
            ...
            skillDossiers: [skillSource('skills/agentic-zero-trust-security/SKILL.md'), skillSource('skills/ostrom-commons-governance/SKILL.md')],
          },
          {
            ...
            skillDossiers: [skillSource('skills/runtime-verification-for-agents/SKILL.md'), skillSource('skills/game-theoretic-agent-incentives/SKILL.md')],
          },
          {
            ...
            skillDossiers: [skillSource('skills/runtime-verification-for-agents/SKILL.md'), skillSource('skills/runtime-verification-for-agents/diagrams/01_flowchart_decision-points.md')],
          },
          {
            ...
            skillDossiers: [skillSource('skills/game-theoretic-agent-incentives/SKILL.md'), skillSource('skills/ostrom-commons-governance/SKILL.md')],
          },
        ],
        skillTrail: [
          skillSource('skills/multi-agent-coordination/SKILL.md'),
          skillSource('skills/agent-conversation-protocols/SKILL.md'),
          skillSource('skills/ipc-communication-patterns/SKILL.md'),
          skillSource('skills/agentic-zero-trust-security/SKILL.md'),
          skillSource('skills/runtime-verification-for-agents/SKILL.md'),
          skillSource('skills/game-theoretic-agent-incentives/SKILL.md'),
          skillSource('skills/ostrom-commons-governance/SKILL.md'),
          skillSource('skills/next-move/SKILL.md'),
          skillSource('skills/next-move/references/runtime-honesty.md'),
          skillSource('docs/METHODOLOGY.md'),
          skillSource('docs/screenshots/skill-search-bm25.png'),
        ],
      },
      goals: [
