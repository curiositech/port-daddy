    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          paragraphs: [
            'This recommendation was checked against the repository\'s Jury-rig skill dossiers, especially `agentic-zero-trust-security`, `tunnels-for-agents`, and `reverse-proxy-for-agents`: reachable does not mean trusted, outbound-only is the default NAT story, and relay headers route envelopes rather than granting authority.',
