      ...
      <motion.div className="max-w-7xl mx-auto relative z-10 font-sans flex flex-col items-center">
              ...
              >
                ...
                <div className="space-y-4 flex-1 flex flex-col items-center">
                   <div className="flex flex-col items-center gap-3">
                      ...
                      <Badge variant="neutral" className="text-[8px] font-black uppercase tracking-widest px-3 py-1">{tool.tagline}</Badge>
                   </div>
        ...
        >
           ...
           <div className="max-w-4xl relative z-10 space-y-12 flex flex-col items-center">
              <Badge variant="amber" className="px-6 py-2 text-[10px] font-black uppercase tracking-widest">Coordination Pattern</Badge>
