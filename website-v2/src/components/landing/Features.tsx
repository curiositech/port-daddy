      ...
      <PageContainer width="wide">
        <div className="mb-[var(--space-7)] grid gap-[var(--space-5)] lg:grid-cols-[minmax(0,0.9fr)_minmax(18rem,0.55fr)] lg:items-end">
          <SectionIntro
            ...
            description="Port Daddy is built as infrastructure first, with a real operator surface on top. FleetBar, Fleet Control Center, sessions, guardrails, inboxes, resources, sorties, Tube, and relay security all point back to the same local daemon state."
            titleAs="h2"
