  ...
  return (
    <section className="relative flex items-center overflow-hidden py-[var(--section-space-y)] lg:py-[var(--section-space-y-lg)]">
      ...
      <PageContainer className="relative z-10">
        <div className="grid items-center gap-[var(--space-6)] min-[900px]:grid-cols-[minmax(0,0.92fr)_minmax(24rem,0.95fr)] min-[900px]:gap-[var(--space-7)]">
          {/* Left -- Copy */}
          <motion.div
          ...
          <motion.div
            ...
            className="relative w-full min-w-0 min-[900px]:justify-self-end"
          >
