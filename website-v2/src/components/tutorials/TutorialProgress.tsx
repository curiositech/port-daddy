...
export function TutorialProgress({
  ...
  const progressSummary = `Lesson ${currentNumber} of ${TUTORIALS.length} - ~${TOTAL_TIME} min total`;
    ...
    <div className="w-full">
      ...
      >
        <div className="flex-1 space-y-[var(--space-2)]">
          ...
          <div className="flex items-center justify-between font-sans text-[length:var(--type-small-size)] leading-[var(--leading-body-compact)] text-[var(--text-muted)]">
