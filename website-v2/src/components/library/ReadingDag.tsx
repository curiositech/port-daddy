    ...
    <figure className="grid gap-[var(--space-4)] border-2 border-[var(--border-strong)] bg-[var(--surface-base)] shadow-[var(--shadow-brutal)]">
      <div className="overflow-x-auto p-[var(--space-5)]">
        ...
        >
          ...
          {/* Connective gloss in the empty lower-left quadrant (below chapter
              IV, beside the proof elbows), so the cross-column dashed links are
              self-explanatory without reading the figcaption. */}
          <g transform="translate(60, 400)">
            <text x="0" y="0" fill="var(--text-muted)" style={{ font: '600 13px var(--font-sans)' }}>
              Each dashed line is a proof
            </text>
            <text x="0" y="18" fill="var(--text-primary)" style={{ font: '700 13px var(--font-sans)' }}>
              on the right discharging a
            </text>
            <text x="0" y="36" fill="var(--text-primary)" style={{ font: '700 13px var(--font-sans)' }}>
              claim made on the left.
            </text>
          </g>
