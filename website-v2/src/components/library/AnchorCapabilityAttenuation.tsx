...
const RINGS: Ring[] = [
  { holder: 'Root cap · daemon', rights: 'db:*  fs:*  net:*', ttl: 'TTL 1h', x: 16, y: 24, w: 408, h: 196, fill: 'var(--surface-raised)', emphasis: false },
  { holder: 'AgentA cap', rights: 'db:write  fs:read', ttl: 'TTL 15m', x: 56, y: 64, w: 296, h: 124, fill: 'var(--surface-base)', emphasis: false },
  { holder: 'AgentB cap', rights: 'db:write', ttl: 'TTL 5m', x: 96, y: 104, w: 184, h: 52, fill: 'var(--brand-primary)', emphasis: true },
]
      ...
      <div className="overflow-x-auto p-[var(--space-5)]">
        ...
        >
          ...
          <g transform="translate(96, 240)">
            <rect width="328" height="40" rx="6" fill="var(--surface-base)" stroke="var(--brand-primary)" strokeWidth="2" strokeDasharray="6 4" />
            <text x="164" y="25" textAnchor="middle" fill="var(--brand-primary)" style={{ font: '700 13px var(--font-sans)' }}>
              ✕ AgentB cannot grant net:* downstream
            </text>
          </g>
          <line x1="188" y1="156" x2="188" y2="240" stroke="var(--brand-primary)" strokeWidth="2" strokeDasharray="6 4" markerEnd={`url(#${arrowId})`} />
        </svg>
      </div>
