...
function CodexMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M12 3.4 18.9 7.3v7.4L12 20.6l-6.9-5.9V7.3L12 3.4Z" stroke="#10A37F" strokeWidth="2" />
      <path d="M7.1 8.9 12 6.1l4.9 2.8v5.6L12 17.9l-4.9-3.4V8.9Z" stroke="#58A6FF" strokeWidth="1.7" />
...
function ClaudeMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M12 2.6 14.3 9.7 21.5 12 14.3 14.3 12 21.4 9.7 14.3 2.5 12 9.7 9.7 12 2.6Z" fill="#D97745" />
...
function OllamaMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path d="M10 13.5h.1M14 13.5h.1" stroke="#10A37F" strokeWidth="2.4" strokeLinecap="round" />
    </svg>
  )
}
...
function CursorMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path d="M13.2 14.1 17.6 18.5" stroke="#58A6FF" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
...
function WindsurfMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M3.3 15.6c3.2-3.9 6.8-5.3 10.8-4.2 2 .6 3.9.5 5.6-.3" stroke="#58A6FF" strokeWidth="2.4" strokeLinecap="round" />
      <path d="M5.2 19.2c3.6-2.2 7-2.8 10.3-1.6 1.8.6 3.5.6 5.2-.1" stroke="#10A37F" strokeWidth="2.1" strokeLinecap="round" />
