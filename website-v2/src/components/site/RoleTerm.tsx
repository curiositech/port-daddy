  ...
  return (
    <span className={`group relative inline-flex align-baseline ${className ?? ''}`}>
      ...
      <span
        id={tooltipId}
        role="tooltip"
        className={`pointer-events-none absolute top-[calc(100%+var(--space-2))] z-[80] hidden w-[min(18rem,calc(100vw-var(--space-6)))] border-2 border-[var(--border-strong)] bg-[var(--surface-raised)] p-[var(--space-3)] text-left opacity-0 shadow-none group-focus-within:block group-focus-within:opacity-100 group-hover:block group-hover:opacity-100 ${tooltipAlignClass}`}
      >
