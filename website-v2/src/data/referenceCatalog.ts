...
export const CLI_REFERENCE_GROUPS: ReferenceGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'pd up', href: '/docs/cli/up', description: 'Start configured or discovered services for the current project.', flags: ['--service', '--no-health', '--branch'] },
      { name: 'pd down', href: '/docs/cli/down', description: 'Stop services started by Port Daddy orchestration.' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'pd note <content>', href: '/docs/cli/note', description: 'Append an immutable note to the active or targeted session.', flags: ['--type', '--session', '--agent'] },
