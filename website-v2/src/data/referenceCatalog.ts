...
export const PORT_DADDY_VERSION = '3.30.2'
...
export const CLI_REFERENCE_GROUPS: ReferenceGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'pd inbox <command>', description: 'Read, send, and acknowledge durable direct messages for agents.' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'pd actor <id>', description: 'Inspect or message a durable actor mailbox.', flags: ['--project', '--message', '--inbox', '--inbox-stats', '--unread', '--mark-read'] },
