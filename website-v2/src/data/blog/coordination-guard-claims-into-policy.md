...
They don't say which session owns the integration commit, or whether two clean branches break the program together. They don't protect generated assets or migrations that need a lock. They won't [salvage a dead agent's intent](/blog/recovery-roadmap-map-truth), and they can't make a cherry-pick explain itself.
