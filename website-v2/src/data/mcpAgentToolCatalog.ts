...
export const MCP_AGENT_TOOL_DEFINITIONS: McpAgentToolDefinition[] = [
  ...
  },
  {
    ...
    "categoryDescription": "Tuple-backed roadmap of record — read progress/claims (cartographer projection), list/get/search items, and promote feedback into a roadmap item",
    "exposure": "discoverable",
  ...
  },
  {
    ...
    "categoryDescription": "Tuple-backed roadmap of record — read progress/claims (cartographer projection), list/get/search items, and promote feedback into a roadmap item",
    "exposure": "discoverable",
    "description": "[Roadmap] Rank roadmap items against free text (BM25 -> cosine over shared MiniLM embeddings, same cascade as pd whois). Use before pd_begin when you know what you are about to work on but not the exact --roadmap slug. Usage: roadmap_search({query: \"fix the login timeout\"})",
    "required": [
      "query"
    ],
    "parameters": [
      ...
      },
      {
        ...
        "type": "string",
        "required": false,
        "description": "Restrict to one harbor (optional)"
      },
      {
        "name": "limit",
        "type": "number",
  ...
  },
  {
    ...
    "categoryDescription": "Tuple-backed roadmap of record — read progress/claims (cartographer projection), list/get/search items, and promote feedback into a roadmap item",
    "exposure": "discoverable",
    "description": "[Roadmap] Push one roadmap item to an external tracker (GitHub Issues, Linear, or Jira). One-way, repeatable push, not two-way sync. Credentials come from server env vars only. Usage: roadmap_export({slug: \"fix-x\", target: \"github\", repo: \"acme/widgets\"})",
    "required": [
      "slug",
      "target"
    ],
    "parameters": [
      {
        ...
        "type": "string",
        "required": true,
        "description": "Roadmap item slug to export"
      },
      {
        "name": "target",
        "type": "enum<github | linear | jira>",
        "required": true,
      ...
      },
      {
        ...
        "type": "string",
        "required": false,
        "description": "GitHub only: \"owner/repo\""
      },
      {
        "name": "teamId",
        "type": "string",
        "required": false,
        "description": "Linear only: team id to file the issue under"
      },
      {
        "name": "baseUrl",
        "type": "string",
        "required": false,
        "description": "Jira only: e.g. https://your-org.atlassian.net"
      },
      {
        "name": "projectKey",
        "type": "string",
        "required": false,
        "description": "Jira only: project key, e.g. \"ROAD\""
      },
      {
        "name": "issueType",
        "type": "string",
        "required": false,
        "description": "Jira only: issue type name (default \"Task\")"
      }
    ],
    "inputSchema": {
      "type": "object",
  ...
  },
  {
    ...
    "categoryDescription": "Semantic search + symbol index — inspect Jury-rig coverage, search the embedding store, resolve identities, find symbols, and predict file/symbol conflicts before claiming",
    "exposure": "discoverable",
    "description": "[Knowledge] Read-only Tool2Vec catalog coverage and checkpoint state. Reports current, cold, reconciling, embedder-down, or generator-down without generating centroids or calling an LLM. Usage: jury_rig_status()",
    "required": [],
    "parameters": [],
    "inputSchema": {
      "type": "object",
  ...
  },
  {
    ...
    "parameters": [
      ...
      },
      {
        ...
        "type": "string",
        "required": false,
        "description": "Existing absolute working directory, required for local CLI/file-capable agents. Omit only for API-only projectless runs; never defaults to the daemon directory."
      },
      {
        "name": "timeout",
        "type": "number",
