...
export const HERO_COPY = {
  ...
  description:
    'One local daemon that publishes its endpoint when it starts. Install it once, and Claude Code, Codex, Cursor, Gemini CLI, Aider, and Ollama can coordinate through shared state backed by a single SQLite database.',
