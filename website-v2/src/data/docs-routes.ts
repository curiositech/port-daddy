...
export const docsFamilyRoutes: DocsFamilyRoute[] = [
    ...
    modules: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Leave notes before broad edits if other agents might touch the same repo.',
  ...
  },
  {
    ...
    title: 'Examples',
    summary:
      'Guided examples for agent handoffs, file claims, tunnel sharing, service discovery, and live status.',
    tone: 'blue',
    path: '/docs/examples',
    aliases: ['examples'],
    intro: [
    ...
    modules: [
      {
        ...
        bullets: [
          ...
          'Show recovery and handoff behavior as part of the workflow, not as an afterthought.',
        ],
      },
      {
        truth: 'Live',
    ...
    modules: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Remote delegation with clear status views',
          'More walkthroughs for deeper runtime surfaces',
        ],
      },
    ],
  },
