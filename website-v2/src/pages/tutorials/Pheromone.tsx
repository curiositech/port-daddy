    ...
    >
      <motion.div className="space-y-16">
        ...
        <section className="space-y-6">
          <motion.div className="flex items-center gap-4 mb-8">
            ...
            <motion.h2 className="m-0">
              Stigmergy: Communication Without Conversation
            </motion.h2>
          </motion.div>
          <motion.p>
            In ant colonies, foragers don&apos;t coordinate by talking. They
            leave pheromone trails on the ground. Other ants follow strong
            trails and ignore fading ones. The trail <em>is</em> the
            coordination &mdash; no central planner, no message passing.
          </motion.p>
          <motion.p>
            Port Daddy&apos;s pheromone system works the same way. Any agent can{" "}
            <strong>spray</strong> a numeric signal (0 to 1) onto any entity
            &mdash; a service, an agent, a session, a lock. The signal{" "}
            <strong>decays over time</strong> automatically. Other agents{" "}
            <strong>sniff</strong> the signal and adjust their behavior based on
            its strength.
          </motion.p>
          <motion.p>
            No channels. No subscriptions. No polling. Just ambient signals that
            fade.
          </motion.p>
        </section>
        ...
        <section className="space-y-8">
          ...
          <motion.p>
            An agent that just spent 5 minutes working on a file can announce
            its intensity:
          </motion.p>
...
curl -X POST http://localhost:9876/pheromone/spray \\
  ...
  -d '{"table": "services", "id": "myapp:api:main", "key": "urgency", "strength": 0.8}'`}</CodeBlock>
          ...
          <motion.p>
            The signal is stored as metadata on the entity. It doesn&apos;t
            create a new record &mdash; it annotates what already exists.{" "}
            <code>strength</code> must be between 0 and 1.
          </motion.p>
        </section>
        ...
        <section className="space-y-8">
          <motion.div className="flex items-center gap-4">
            ...
            <motion.h2 className="m-0">
              2. Sniff a Signal (Read-Time Decay)
            </motion.h2>
          </motion.div>
          ...
          <motion.p>
            ...
            <strong>
              pheromones decay when you read them, not when you write them.
            </strong>{" "}
            Every time an agent sniffs a signal, the value returned reflects how
            much time has passed since it was sprayed. Old signals are weaker.
...
# }`}</CodeBlock>
          ...
          <Surface depth="raised" radius="none" className="p-6 space-y-3">
            ...
            <motion.p className="text-xs text-[var(--text-secondary)] m-0">
              ...
              after 12 minutes, 0.13 after an hour, and effectively 0 after a
              few hours. You never have to clean up &mdash; signals self-heal.
            </motion.p>
          </Surface>
        </section>
        ...
        <section className="space-y-8">
          ...
          <motion.p>
            The most practical use of pheromones:{" "}
            <strong>which files are your agents fighting over?</strong>
          </motion.p>

          <motion.p>
            The file heat map aggregates session file claims into per-file
            contention scores. Files claimed by multiple active sessions glow
            red. Files with a single owner glow green. Files nobody has touched
            are cold.
          </motion.p>
          ...
          <motion.div className="grid sm:grid-cols-2 gap-6">
            <Surface depth="raised" radius="none" className="p-6 space-y-3">
              ...
              <motion.p className="text-xs text-[var(--text-secondary)] m-0">
                ...
                agents and relax for trusted ones.
              </motion.p>
            </Surface>
            <Surface depth="raised" radius="none" className="p-6 space-y-3">
              <motion.h3 className="text-sm font-bold m-0">
            ...
            <Surface depth="raised" radius="none" className="p-6 space-y-3">
              ...
              <motion.p className="text-xs text-[var(--text-secondary)] m-0">
                ...
                get demoted to cheaper backends.
              </motion.p>
            </Surface>
            <Surface depth="raised" radius="none" className="p-6 space-y-3">
              <motion.h3 className="text-sm font-bold m-0">
                ...
                <tbody className="text-[var(--text-secondary)]">
                  <tr>
                    <td className="py-1 pr-4">
                      <code>/pheromone/spray</code>
                    </td>
                    <td className="pr-4">POST</td>
                    <td>Set a signal on an entity</td>
                  </tr>
                  <tr>
                    <td className="py-1 pr-4">
                      <code>/pheromone/:table/:id</code>
                    </td>
                    <td className="pr-4">GET</td>
                    <td>Read signals (with decay)</td>
                  </tr>
                  <tr>
                    <td className="py-1 pr-4">
                      <code>/pheromone</code>
                    ...
                    <td className="pr-4">GET</td>
                    <td>List all non-zero signals</td>
                  </tr>
                  <tr>
                    <td className="py-1 pr-4">
                      <code>/pheromone/files</code>
                    </td>
                    <td className="pr-4">GET</td>
                    <td>File heat map</td>
                  </tr>
