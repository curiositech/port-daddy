      ...
      <div className="space-y-12">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-[var(--text-secondary)]">
            <strong>Zero Config</strong> -- Sugar commands auto-detect your project root and existing sessions so you don't have to pass IDs.
            <strong> Safe Defaults</strong> -- Built-in timeouts and retry logic ensure that your agent scripts are resilient to network blips.
          </p>
        </section>
    ...
    --files "logs/*.log"`}
        ...
        <section className="space-y-4">
          ...
          <Surface depth="raised" radius="xl" className="p-5 space-y-3">
             <p className="text-sm font-black uppercase tracking-widest text-[var(--text-muted)] m-0">Productivity HUD</p>
             <div className="space-y-2">
                <Surface depth="inset" radius="xl" padding="none" className="flex items-center justify-between p-3">
                   <div className="flex items-center gap-3">
                      <Terminal size={14} className="opacity-40" />
                      <code className="text-xs">pd whoami</code>
                   </div>
                   <span className="text-[10px] font-mono text-[var(--text-muted)]">Identify current agent</span>
                </Surface>
                <Surface depth="inset" radius="xl" padding="none" className="flex items-center justify-between p-3">
                   <div className="flex items-center gap-3">
                      <Terminal size={14} className="opacity-40" />
                   ...
                   <span className="text-[10px] font-mono text-[var(--text-muted)]">Recover orphaned work</span>
                </Surface>
             </div>
          </Surface>
        </section>
        ...
        <Surface depth="raised" radius="xl" className="p-6 space-y-4">
           <div className="flex items-center gap-3">
             ...
             <p className="text-xs font-black uppercase tracking-widest text-[var(--text-muted)] m-0">Efficiency Maturity</p>
           </div>
           <p className="m-0 text-[var(--text-secondary)]">
             Multi-agent coordination is complex, but the interface shouldn't be. Port Daddy's sugar commands turn deep infrastructure primitives into a "standard library" for your agent swarm prompts. Zero-config coordination means agents can focus on their task, not on plumbing.
           </p>
        </Surface>
      </div>
    </TutorialLayout>
