...
import { Eye, Zap, Terminal, Shield, Share2, RefreshCw, Layers, ArrowDown } from 'lucide-react'
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-start gap-3">
              ...
              <p className="m-0 text-sm"><strong>Sub-50ms Reaction</strong> -- The moment an agent publishes a note or a message, your watcher script is spawned by the daemon.</p>
            </div>
            <div className="flex items-start gap-3">
              <Layers size={18} className="text-[var(--brand-secondary)] mt-0.5 shrink-0" />
              <p className="m-0 text-sm"><strong>Scriptable Swarms</strong> -- Use any local binary or shell script as a reactive "agent" that handles infrastructure tasks.</p>
            </div>
          </div>
        </section>
    ...
    --filter "payload.status == 'ready'"`}
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            <Surface depth="inset" radius="xl" padding="none" className="p-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
            ...
            <Surface depth="raised" radius="xl" className="p-3 flex items-center justify-between">
              <div className="flex items-center gap-3">
            ...
            <div className="flex justify-center"><ArrowDown size={14} className="opacity-20" /></div>
            <Surface depth="inset" radius="xl" padding="none" className="p-3 flex items-center justify-between opacity-60">
              <div className="flex items-center gap-3">
                <RefreshCw size={14} />
