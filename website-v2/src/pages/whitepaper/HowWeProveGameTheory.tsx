...
// core fragment of `proofs/economics/claim_signaling.tla` (full file
            ...
            <div className="grid gap-[var(--space-6)] lg:grid-cols-[minmax(0,0.66fr)_minmax(0,0.34fr)]">
              <article className="space-y-[var(--space-5)]">
                ...
                <Prose>
                  ...
                  <p>
                    Below is the essential fragment of{' '}
              ...
              <div className="grid gap-[var(--space-3)]">
                {[
                  ...
                  },
                  {
                    ...
                    body: 'The price-of-anarchy paper. Short, technical, and quietly structural for half of mechanism design after it.',
                  },
                  {
