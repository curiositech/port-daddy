...
const FLEET_AGENTS: FleetAgent[] = [
  ...
  },
  {
    ...
    runtime: 'cli:claude-code, then codex, then OpenAI gpt-5.6-luna',
  ...
  },
  {
    ...
    runtime: 'cli:claude-code, then codex, then anthropic haiku (soft), OpenAI gpt-5.6-luna, or Cloudflare qwen-coder',
  ...
  },
  {
    ...
    runtime: 'cli:claude-code, then codex, then OpenAI gpt-5.6-luna, or Cloudflare qwen-coder',
  ...
  },
  {
    ...
    runtime: 'cli:claude-code, then codex, then anthropic haiku (soft), OpenAI gpt-5.6-luna, or Cloudflare qwen3',
