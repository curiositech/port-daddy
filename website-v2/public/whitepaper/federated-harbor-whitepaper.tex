...
% pdnum id=fh-residual-ring kind=arithmetic scope=block
%   expr="sqrt(4 * 0.75 ** 2)" value=1.5 prints="r=\sqrt{4\times0.75^{2}}=1.5"
% pdnum id=fh-residual-c8 kind=arithmetic scope=block
%   expr="2 / sqrt(8)" value=0.7071 prints="$2/\sqrt8=0.7071$"
...
% pdnum id=fh-radius-c6 kind=arithmetic scope=block
%   expr="3 / sqrt(6)" value=1.2247 prints="\tfrac{3}{\sqrt6} \;=\; 1.2247"
% pdnum id=fh-radius-c6-printed kind=arithmetic scope=block
%   expr="3 * sqrt(1 - 5 / 6)" value=1.224745
%   prints="C6 relayed cycle edge, lie 3.0:  r = 1.224745"
%   note="the lstlisting quotes the script's own printed line; the arithmetic behind it is
%         the closed form the same line prints beside it"
% pdnum id=fh-tol-silent kind=code scope=block
%   file=skills/harbor-results/scripts/sheaf_consistency_radius.py symbol=TOL_SILENT
%   value=1e-9 digits="10^{-9}" prints="under $10^{-9}$ (the script's own \texttt{TOL\_SILENT}"
% pdnum id=fh-dilution-c8 kind=arithmetic scope=block
%   expr="1 / sqrt(8)" value=0.3536 prints="$|s|/\sqrt8\approx0.3536|s|$"
...
% pdnum id=fh-bond-split kind=arithmetic scope=block
%   expr="90 + 10" value=100 prints="the four sum to 100"
