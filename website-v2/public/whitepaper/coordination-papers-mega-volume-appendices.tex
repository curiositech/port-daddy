...
strongest design described in Chapter~II, and filesystem or network effects
...
information floor proved in Chapter~I; coverage, omission, and review latency
...
settlement institutions described in Chapter~VII.
...
\paragraph{I. Supervision has an information cost (R1--R4, R14, R16).}
...
\paragraph{II. Prevention begins at the effect boundary (R5, R8).}
...
\paragraph{III. Accountability outlives the process (R12, R13, B6).}
...
\paragraph{IV. Exchange separates payment, collateral, evidence, and closure
(R7, R13--R15).}
...
\paragraph{V. Delegation only narrows (ANCHOR-ATTENUATION, R5).}
...
\paragraph{VI. Uncertainty needs an institution (R7, R8, R10, R11, R15, R17).}
...
\paragraph{VII. Federation relays evidence, not sovereignty (R6, R6-CR,
RELAY-V0).}
