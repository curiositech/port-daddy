...
\vspace{0.4cm}
\noindent\textit{Reading time: approximately 30 minutes end-to-end. The companion paper, \emph{The Bonded Commons: Agent Transactions and the Federated Sovereign} (Owens 2026), carries the economic and governance argument; either paper can be read first.}
