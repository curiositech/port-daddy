...
\begin{table}[H]
\centering
\caption{The three failure modes of \S\ref{sec:problem}, where each is closed, and what remains open. The residual column is deliberately non-empty in every row: no mechanism in this chapter closes its threat completely.}
