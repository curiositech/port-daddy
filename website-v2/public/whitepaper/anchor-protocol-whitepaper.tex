...
The v2.6 round closes the cuckoo-filter pollution open item and lands the multi-hop delegation walker that binds runtime to the depth-$N$ ProVerif chain-replay proof. Algorithm diagrams for both are placed inline near their discussion in \S\ref{sec:revocation} (cuckoo) and \S\ref{sec:delegation} (delegation walker).
...
\pullquote{The discipline came from being argued with for five rounds by an adversarial reviewer that does not flatter.}
