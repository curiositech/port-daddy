...
\newcommand{\pdbookrail}[2]{%
  \par\addvspace{12pt}%
  % A short opening/handoff is one paragraph, not a page-turn destination
  % for its last two lines. Keep the accent and its complete prose together.
...
\newcommand{\pdchapterhandoffstp}{%
  \pdbookrail{What \pdchapref{he}{The Harbor Economy} receives}{%
    A successor inherits bounded history and obligations, not new credit.
    The next chapter asks how that attributed work can be exchanged, and
    separates value, collateral, evidence, and settlement.}%
}
...
\newcommand{\pdchapterhandoffbonded}{%
  \pdbookrail{What \pdchapref{fh}{The Federated Harbor} receives}{%
    One machine can authorize, observe, adjudicate, and settle work.
    The final chapter asks which capabilities and records may cross to a
    second operator without giving either machine authority over the other.}%
}
