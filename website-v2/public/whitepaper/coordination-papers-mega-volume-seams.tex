...
\newcommand{\pdbookrail}[2]{%
  ...
  \vspace{0.12cm}%
  \noindent{\small\scshape\bfseries\color{\pdcurrentchaptercolor}#1}\enspace
  {\small #2}\par
  \vspace{0.45cm}%
}
...
\newcommand{\pdchapterhandoffanchor}{%
  \pdbookrail{What \pdchapref{ls}{The Legible Swarm} receives}{%
    ...
    that admits it keeps one durable history. Together they form a machine that
    can be held to account. The next chapter asks the human question: with many
    such machines running at once, what must remain visible to the operator, and
    at what cost?}%
}
