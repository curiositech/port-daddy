...
\begin{tikzpicture}[pd figure,x=1cm,y=1cm]
  ...
  \foreach \x in {2.3,4.9,6.2} \draw[pd hairline] (\x,6.18) -- (4.9,4.85);
  \node[pd focus datum] (draw) at (4.9,4.60) {};
  \node[pd focus label,anchor=west] at (5.15,4.60) {public draw from eligible pool};
  ...
  \draw[pd breach rule,line width=1.45pt] (4.9,1.55) -- (9.9,1.55);
  \node[pd breach datum] at (4.9,1.55) {};
  \node[pd breach datum] at (9.9,1.55) {};
  \node[pd breach label,anchor=south east,text width=4.0cm,align=right] at (6.9,1.80)
    {judge bond remains exposed through the dispute window};
  \draw[pd breach arrow] (9.9,3.05) -- (9.9,1.80);
  ...
  \draw[pd focus rule] (1.3,0.40) -- (8.3,0.40);
  \node[pd focus label,anchor=north,text width=9.0cm,align=center] at (4.8,0.20)
...
rather than a title attached to the chosen judge. [internal]}
