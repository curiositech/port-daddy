...
\begin{tikzpicture}[pd figure]
  ...
  \begin{axis}[name=top,xtick=\empty,anchor=north west,at={(0cm,0cm)}]
    \addplot[pd rule,draw=hhink,line width=.62pt,forget plot,domain=0:57,samples=2]{1};
    \addplot[pd focus rule,draw=hhteal,line width=1.15pt,forget plot]
  ...
  \begin{axis}[name=mid,xtick=\empty,anchor=north west,at={(0cm,-2.72cm)}]
    ...
    \addplot[pd rule,draw=hhink,line width=.62pt,forget plot,domain=0:57,samples=2]{1};
    \addplot[pd rule,draw=hhink,line width=1.0pt,forget plot]
  ...
  \begin{axis}[name=bot,anchor=north west,at={(0cm,-5.44cm)},
    ...
    \addplot[pd rule,draw=hhink,line width=.62pt,forget plot,domain=0:57,samples=2]{1};
    \addplot[pd caution rule,draw=hhamber,line width=1.15pt,dash pattern=on 3pt off 2pt,forget plot]
    ...
    \node[pd direct label,text=hhamber,anchor=west] at (axis cs:1.0,4.0)
      {bribery phase};
    \node[pd row label,anchor=north east,yshift=-4pt] at (axis cs:56.5,320) {one clique};
  \end{axis}
