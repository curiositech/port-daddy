...
\begin{tikzpicture}[
  ...
  flow/.style={->,>=Latex,thick,draw=cinnabar},
  hashflow/.style={->,>=Latex,thick,draw=patina},
]
...
\node[slot,fill=brass!50] at (b0s0)  {a3};
\node[slot,fill=brass!50] at (b0s1)  {7e};
\node[slot,fill=brass!50] at (b0s2)  {2f};
\node[slot,fill=brass!50] at (b0s3)  {91};

\node[slot,fill=brass!50] at (b3s0)  {ca};
\node[slot,fill=brass!50] at (b3s1)  {1b};
\node[slot,fill=brass!50] at (b3s2)  {ff};
\node[slot,fill=brass!50] at (b3s3)  {44};

\node[slot,fill=brass!30] at (b1s0)  {6c};
\node[slot,fill=brass!30] at (b2s2)  {8a};
\node[slot,fill=brass!30] at (b4s1)  {19};
\node[slot,fill=brass!30] at (b5s3)  {b2};
...
\node[draw=patina,thick,fill=paper,rounded corners=2pt,inner sep=3pt,
...
\node[slot,fill=cinnabar!70,text=white] at (b0s2) {c1};   % new fp lands here
\node[slot,draw=cinnabar,thick,fill=paper] (kicked) at (b0s2.south) {};
...
\node[draw=cinnabar,thick,fill=paper,rounded corners=3pt,inner sep=4pt,
