...
\begin{tikzpicture}[pd figure,x=1cm,y=1cm]
  \node[pd title,anchor=west] at (0,3.35) {witnessed outcome profiles remain vectors};
  ...
  \node[pd focus label,anchor=west] at (6.60,1.17) {outcome A};
  \node[pd breach label,anchor=west] at (6.60,2.60) {outcome B};
