...
\node[rung,fill=hhsand!30,draw=hhcobalt,very thick,above=5mm of l2] (l3)
  {{\bfseries L3 --- Economy \& federation}\hfill{\footnotesize\textsc{for operators, plural \& distrusting}}\\[2pt]
   \textit{cross-harbor capability transfer, float-plan escrow, reputation, federation}\hfill{\footnotesize\textsc{whitepaper'd}}};
...
\node[paper,anchor=east] at ([xshift=-9mm]$(l2.north west)!0.5!(l3.south west)$) {Paper 3\\\emph{the bridge}};
\node[paper,draw=hhcobalt,very thick,anchor=east] at ([xshift=-9mm]l3.west) {\textbf{Paper 4}\\\emph{this}};
...
chain from L1, and the legible \emph{person} from Paper~3, and turns them into a
market. The volume's spine runs straight up this stack: memory $\to$ checkpoint
