...
\tikzset{
  ...
  pd direct label/.style={font=\pdfiglabel,text=hhink,align=left,inner sep=1.5pt,fill=hhpaper},
  ...
  pd mono label/.style={pd direct label,font=\pdfiglabelmono,inner sep=2.5pt},
