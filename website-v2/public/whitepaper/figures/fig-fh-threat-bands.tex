...
\begin{tikzpicture}[pd figure,x=1cm,y=1cm]
  \def\lx{1.85}   \def\x0{2.05}   \def\pw{8.35}
  ...
  \foreach \y/\lab in {3.30/{identity + replay},1.90/{revocation},0.50/{equivocation},
    ...
    -5.40/{centralization}}
    {\node[pd label,anchor=east,text width=1.75cm,align=right] at (\lx,\y) {\lab};
  ...
  \node[pd label,anchor=south east,text width=3.4cm,align=right] at (4.96,-2.12)
  ...
  \node[pd label,anchor=south east,text width=3.4cm,align=right] at (4.66,-3.52)
  ...
  \node[pd label,anchor=south east,text width=3.4cm,align=right] at (4.22,-5.22)
