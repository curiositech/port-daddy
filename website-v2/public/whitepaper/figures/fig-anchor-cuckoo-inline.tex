...
\begin{tikzpicture}[
  ...
  flow/.style={->,>=Latex,thick,draw=hhteal},
...
\node[slot,fill=hhteal!85,text=white] at (b0s2) {c1};
\draw[flow,line width=1.4pt]
  (b0s2.west) -- ++(-0.6,0)
  node[midway,above=5mm,font=\footnotesize,text=hhteal,align=center]
  {evict\\\texttt{2f}}
...
\node[draw=hhamber,thick,fill=hhamber!6,rounded corners=3pt,inner sep=4pt,
