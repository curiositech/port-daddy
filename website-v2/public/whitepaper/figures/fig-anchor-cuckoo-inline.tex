...
\draw[flow,line width=1.4pt]
  (b0s2.west) -- ++(-0.6,0)
  node[midway,above=5mm,font=\sffamily\footnotesize,text=hhcobalt,align=center]
  {evict\\\texttt{2f}}
...
\node[draw=hhamber,thick,fill=hhpaper,rounded corners=3pt,inner sep=4pt,
      align=left,anchor=north west,text=hhamber] at (5.5,-2.6)
