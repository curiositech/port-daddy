...
\begin{tikzpicture}[pd figure,x=1cm,y=1cm]
  ...
  \node[pd title,anchor=east,align=right,text width=2.6cm] at (\rx-.20,{\ymid+\ch/2}) {ledger balance\\\footnotesize\itshape the recorded sum};
  \node[pd title,anchor=east,align=right,text width=2.6cm] at (\rx-.20,{\ymid-\ch/2}) {budget cap\\\footnotesize\itshape spend at or under the limit};
  % --- grid rules --------------------------------------------------------
  ...
  \node[pd note,text=pdink,anchor=west,align=left,text=pdinkmuted] at ({\ca+.55},{\ybot+\ch/2}) {not exercised};
