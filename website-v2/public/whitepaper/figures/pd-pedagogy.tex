...
\newcommand{\pd@placemargin}[1]{%
  ...
  \fi
  \ifnum\pd@blockpage=\thepage\relax
    \ifdim\pd@blockoff<\dimexpr\pd@blockbottom-\pagetotal\relax
      \setlength{\pd@blockoff}{\dimexpr\pd@blockbottom-\pagetotal\relax}\fi
  \fi
  ...
  \ifpdmargincolumn
    \IfBooleanTF{#1}%
      ...
      {\sbox{\pd@ptrbox}{\begin{minipage}[b]{\marginparwidth}\marginfont
         \small\itshape Exercises #2--#3, p.~#4.\end{minipage}}\pd@placemargin{\pd@ptrbox}}%
  \else
...
\NewDocumentCommand{\pdexercisepointerone}{s m m}{%
  \ifpdmargincolumn
    \IfBooleanTF{#1}%
      ...
      {\sbox{\pd@ptrbox}{\begin{minipage}[b]{\marginparwidth}\marginfont
         \small\itshape Exercise #2, p.~#3.\end{minipage}}\pd@placemargin{\pd@ptrbox}}%
  \else
