...
% and no upward offset is ever computed. The cost is that a standalone chapter
% now prints its table and figure captions above the float rather than below;
% that is the conventional position for a table caption and a defensible one
% for a figure, and it is the whole of the visible change to the paper twins.
%
...
%
% Outside the margin column (a standalone A4 chapter) this is exactly
% \caption{#1}. All three editions share one chapter source and this macro, and
...
% (references/margin-apparatus.md section 3.2). Outside the margin column it
% is exactly \footnote, so a standalone chapter keeps its foot notes.
%
