...
\newcommand{\pdreflectiontocentry}[2]{%
  \begin{minipage}[c]{.25\linewidth}%
    \includegraphics[width=\linewidth,height=.85in,keepaspectratio]{plates/interstitial/#1.png}%
  \end{minipage}\hfill
  \begin{minipage}[c]{.65\linewidth}\raggedright\small
    \textbf{Plate: #2}%
  \end{minipage}\hfill
  \makebox[.06\linewidth][r]{\small\ifdefined\pdcurrentplatepage\pdcurrentplatepage\fi}}
\newcommand*{\l@pdplate}[2]{%
  \par\addvspace{6pt}\noindent
  \def\pdcurrentplatepage{#2}%
  #1%
  \par\addvspace{6pt}}
