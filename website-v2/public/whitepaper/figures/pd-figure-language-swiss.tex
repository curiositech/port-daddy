% Swiss edition overrides (v2 role names): small-optical-size serif labels, disciplined colour,
...
% Plots: square marks, heavier spines, caption-cut serif carries the ticks.
\pgfplotsset{
