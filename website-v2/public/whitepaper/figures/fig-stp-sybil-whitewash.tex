...
\begin{tikzpicture}[pd figure,x=1cm,y=1cm]
  ...
  \node[pd focus label,anchor=north east,text width=2.3cm,align=right] at (\pw,1.15) {one principal = one accountable weight};
  ...
  \end{scope}
  \node[pd note,anchor=west,text width=10.4cm] at (0,-1.15)
