...
\begin{tikzpicture}[
  ...
  commons/.style={draw=ebony,thick,fill=patina!40,rounded corners=2pt,
                  inner sep=4pt,minimum width=22mm,align=center},
  escrow/.style={draw=ebony,thick,fill=brass!30,rounded corners=2pt,
                 inner sep=4pt,minimum width=22mm,align=center},
...
\node[draw=cinnabar,thick,fill=paper,rounded corners=2pt,
...
\node[draw=cinnabar,thick,fill=paper,rounded corners=2pt,inner sep=2pt,
...
\draw[arr,line width=1.6pt,draw=cinnabar] (i2.south) --
...
\node[draw=patina,thick,fill=paper,rounded corners=2pt,
