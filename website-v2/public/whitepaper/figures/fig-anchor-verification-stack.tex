...
\end{tikzpicture}
\caption{Obligations descend from model to source to binary; tool evidence returns upward. The two correspondence gaps still require human justification. [internal, Table~\ref{tab:anchor-verification-stack}]}
