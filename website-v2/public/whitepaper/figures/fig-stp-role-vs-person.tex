...
\begin{tikzpicture}[pd figure,x=1cm,y=1cm]
  ...
  \node[pd label,anchor=east,align=right,text width=2.65cm] at ({\x0-.20},6.10)
  ...
  \node[pd note,anchor=west,text width=10.0cm,align=left] at (\x0,5.10)
  ...
  \node[pd focus label,anchor=east,align=right,text width=2.65cm] at ({\x0-.20},3.10)
  ...
  \node[pd focus label,anchor=west,text width=10.0cm,align=left] at (\x0,0.80)
