...
\newcommand{\pdpart}[5]{%
  ...
  \IfFileExists{plates/part-#1.jpg}{%
    ...
    \vspace{0.22cm}
    \noindent{\pdpartface\fontsize{36}{42}\selectfont #2\par}
    \vspace{0.65cm}
    \noindent\begin{minipage}{0.86\textwidth}{\pdpartface\itshape\fontsize{12.5}{16.5}\selectfont\hyphenpenalty=10000\exhyphenpenalty=10000\raggedright #4\par}\end{minipage}\par
    \vspace{0.85cm}
    {\hypersetup{linkcolor=hhink}\noindent\begin{minipage}{0.96\textwidth}#5\end{minipage}\par}
    \vfill
  }{%
