...
\newcommand{\pdchapter}[4]{%
  ...
  \thispagestyle{empty}%
  \vspace*{0.1cm}
  \noindent{\scshape\footnotesize\color{#4}Chapter #1 of \pdchaptercount\hfill\pdchapterpartlabel}\par
  \vspace{0.25cm}
  ...
  \IfFileExists{plates/chapter-#3.jpg}{%
    \begin{center}\includegraphics[width=\textwidth,height=0.36\textheight,keepaspectratio]{plates/chapter-#3.jpg}\end{center}}{}%
  \vfill
  \noindent{\scshape\footnotesize\color{hhgray}The question this chapter answers}\par
  \vspace{6pt}
  {\noindent\fontsize{22}{27}\selectfont\bfseries\color{#4}\pdchapterquestion\par}
  \vspace{10pt}
...
\newcommand{\pdpart}[5]{%
  ...
  \IfFileExists{plates/part-#1.jpg}{%
    \noindent\begin{center}\fcolorbox{hhpaper}{hhpaper}{\includegraphics[width=\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax,height=0.38\textheight,keepaspectratio]{plates/part-#1.jpg}}\end{center}}{}%
  \clearpage
...
\newcommand{\pdcontentspart}[3]{%
  ...
  \begin{lrbox}{\pdbandbox}\begin{minipage}[t]{\pdbandwidth}%
    \vspace{9pt}%
    {\noindent\scshape\bfseries\color{#3}Part #1\enspace\textperiodcentered\enspace #2}\par\vspace{5pt}}
