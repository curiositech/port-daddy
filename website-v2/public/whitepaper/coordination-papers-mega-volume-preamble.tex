...
\makeatother
\definecolor{pdtechorange}{HTML}{C8641E}
\definecolor{pdtechochre}{HTML}{B08A2E}
\definecolor{pdtecholive}{HTML}{5E6B3A}
...
\def\pd@chapter@swiss#1#2#3#4{%
  ...
  \noindent\begin{tikzpicture}
    ...
    \node[anchor=south west,text=hhpaper,font=\pdgrotesk\fontsize{96}{96}\selectfont\bfseries,inner sep=0pt]
      at (0.4cm,{-0.36\textheight+3.2cm}) {#1};
...
\def\pd@chapter@technical#1#2#3#4{%
  ...
  \vspace{0.9cm}
  \noindent{\pdgrotesk\fontsize{96}{96}\selectfont\color{pdtechorange}#1\par}
  \vspace{0.6cm}
...
\def\pd@techsheet#1#2{%
  \AddToShipoutPictureBG*{\AtPageLowerLeft{\begin{tikzpicture}[x=1in,y=1in]
    \draw[hhgray!28,line width=.3pt,step=0.25] (0.6,0.6) grid (6.4,9.4);
    ...
    \fill[hhpaper] (3.3,0.5) rectangle (6.5,1.45);
    \draw[hhink,line width=.6pt] (3.3,0.5) rectangle (6.5,1.45);
    \draw[hhink,line width=.4pt] (3.3,0.98)--(6.5,0.98) (5.25,0.5)--(5.25,1.45) (5.9,0.5)--(5.9,1.45);
    \node[anchor=north west,font=\pdgrotesk\fontsize{5.5}{6}\selectfont,text=hhgray,inner sep=2pt] at (3.3,1.45) {TITLE};
    \node[anchor=south west,font=\pdgrotesk\footnotesize,text=hhink,text width=1.85in,align=left,inner sep=3pt] at (3.3,0.98) {#1};
    \node[anchor=north west,font=\pdgrotesk\fontsize{5.5}{6}\selectfont,text=hhgray,inner sep=2pt] at (5.25,1.45) {SHEET};
    \node[anchor=south west,font=\pdgrotesk\footnotesize,text=hhink,inner sep=3pt] at (5.25,0.98) {#2};
    ...
    \node[anchor=north west,font=\pdgrotesk\fontsize{5.5}{6}\selectfont,text=hhgray,inner sep=2pt] at (3.3,0.98) {WORK};
    \node[anchor=south west,font=\pdgrotesk\footnotesize,text=hhink,text width=1.85in,align=left,inner sep=3pt] at (3.3,0.5) {\pdeditiontitle};
    \node[anchor=north west,font=\pdgrotesk\fontsize{5.5}{6}\selectfont,text=hhgray,inner sep=2pt] at (5.25,0.98) {DATE};
    \node[anchor=south west,font=\pdgrotesk\footnotesize,text=hhink,inner sep=3pt] at (5.25,0.5) {\pdeditiondate};
...
\def\pd@part@technical#1#2#3#4#5{%
    ...
    \vspace{0.3cm}\noindent{\color{hhink}\rule{\linewidth}{0.5pt}}\par
    \vspace{1.4cm}
    \noindent{\pdgrotesk\fontsize{140}{140}\selectfont\color{pdtechorange}#1\par}
    \vspace{0.9cm}
