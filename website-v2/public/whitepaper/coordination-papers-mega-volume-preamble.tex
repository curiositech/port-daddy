...
% The shared typography module selects the Swiss serif after edition setup
...
\def\pd@chapter@swiss#1#2#3#4{%
  ...
  % plate size let a longer serif-set question push the quote onto the next
...
% .toc; textbook.json supplies only the part art key, hue and chapter summaries.
...
\newcommand{\pdcontentschaptermeta}[3]{%
