...
\usepackage{etoolbox}
% Protocol frames use breakable skins; this dependency is absent from the
% baseline pedagogy layer and is intentionally explicit in the Book preamble.
...
% Keep the original counters and title APIs; reserve space before the anchor
% and allow the prose to split instead of boxing it into one minipage.
