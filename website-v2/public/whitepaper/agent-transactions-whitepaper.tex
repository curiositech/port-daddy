...
In the Port Daddy implementation, the commons authority is a local daemon that publishes its selected loopback endpoint and is backed by SQLite. The simplicity of the implementation is deliberate: the authority's value comes from its \emph{guarantees}, not its complexity.
