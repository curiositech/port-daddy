...
Figure~\ref{fig:bonded-merkle-forest} follows one receipt from an ordered note
through its session and harbor inclusion paths, then totals the bytes carried
by those two proofs and the harbor signature.
