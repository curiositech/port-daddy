...
\noindent\pdchapref{anchor}{The Anchor Protocol} supplies the ProVerif-verified cryptographic-token foundation this chapter assumes throughout---Harbor Card phases, cuckoo-filter revocation, bounded multi-hop delegation; this chapter builds the economic and governance argument on top of it, in the order the table of contents below lists, with no shortcut path substituting for that order: each layer's guarantee is a precondition the next layer's argument leans on.
