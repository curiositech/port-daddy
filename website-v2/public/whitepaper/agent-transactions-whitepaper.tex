...
Figure~\ref{fig:bonded-merkle-forest} draws all three tiers together, with the proof-size arithmetic set at the point a proof crosses from the session tier to the harbor tier.
