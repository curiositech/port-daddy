...
Claim-signaling IC (\S\ref{sec:economic}) & TLA+ (TLC) + Z3 SMT & \Closed\ unique root $\delta^\star{\approx}0.2531$; IC invariant holds at $\delta = 0.26$ & \texttt{claim-signaling.tla}, \texttt{delta-threshold.z3} \\
