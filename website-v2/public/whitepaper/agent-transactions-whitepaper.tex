...
% pdnum id=bonded-delta-sq kind=arithmetic scope=block
%   expr="0.3425 * 0.3425" value=0.11730625
%   prints="$\delta^2 = 0.3425 \times 0.3425 = 0.11730625$"
% pdnum id=bonded-delta-poly kind=arithmetic scope=block
%   expr="2 * 0.3425 * (1 + 0.3425 + 0.3425 ** 2) - 1" value=-0.0000327 tol=1e-7
%   prints="f(0.3425) \approx 0.9999672813 - 1 = -0.0000327$"
% pdnum id=bonded-delta-root kind=artifact scope=block
%   file=proofs/economics/delta-threshold.expected.txt
%   pattern="Numerically delta\* . (0\.\d+)" value=0.3425080314
%   prints="$\delta^\star \approx 0.3425080314$"
...
% pdnum id=bonded-ledger-before kind=arithmetic scope=block
%   expr="4 + 6 + 0" value=10 prints="$S_P = 4+6+0=10$"
% pdnum id=bonded-ledger-refund kind=arithmetic scope=block
%   expr="6 - 2" value=4 prints="$b-p=6-2=4$"
% pdnum id=bonded-ledger-after kind=arithmetic scope=block
%   expr="8 + 0 + 2" value=10 prints="$S_P=8+0+2=10$"
% pdnum id=bonded-tlc-states kind=artifact scope=block
%   file=proofs/bonded/conservation/Conservation.run.log
%   pattern="(\d+) distinct states found" value=1716
%   prints="all $1{,}716$ reachable states"
...
% pdnum id=bonded-tlc-verdict kind=artifact
%   file=proofs/bonded/conservation/Conservation.run.log
%   pattern="(No error has been found)" value="No error has been found"
%   digits="No error has been found" prints="``No error has been found''"
% pdnum id=bonded-tlc-depth kind=artifact
%   file=proofs/bonded/conservation/Conservation.run.log
%   pattern="The depth of the complete state graph search is (\d+)\." value=9
%   prints="to search depth $9$"
...
% pdnum id=bonded-tlc-distinct-row kind=artifact
%   file=proofs/bonded/conservation/Conservation.run.log
%   pattern="(\d+) distinct states found" value=1716 prints="1{,}716 reachable states"
% pdnum id=bonded-tlc-generated-row kind=artifact
%   file=proofs/bonded/conservation/Conservation.run.log
%   pattern="(\d+) states generated" value=26818 prints="(26{,}818 generated)"
