...
\newenvironment{protocol}[1][]{%
  ...
  \begin{tikzpicture}
  \node[draw=darkblue,thick,fill=darkblue!5,rounded corners=3pt,
        inner sep=10pt,text width=\dimexpr\textwidth-26pt\relax,align=left]
        \bgroup\begin{minipage}{\dimexpr\textwidth-46pt\relax}
  {\sffamily\bfseries\color{darkblue} Protocol~\theprotocol.}%
  \ifx\\#1\\\else\ {\sffamily\bfseries #1}\fi\par\vspace{3pt}
  \small
}{%
  \end{minipage}\egroup;
  \end{tikzpicture}\par\vspace{8pt}
...
\fancyfoot[C]{\small Harbor Volume, Paper 3 of 4 \quad\textbar\quad
  Maturity: \BUILT~\textbar~\BUILTWEAK~\textbar~\DESIGNED~\textbar~\VISION}
