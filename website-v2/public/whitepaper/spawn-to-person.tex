...
\fancyfoot[C]{\footnotesize\color{hhgray} The Harbor Volume \textperiodcentered\ Paper 3 of 4}
...
\date{August 2026\\Version 1.2 (Harbor Volume, L3 bridge)}
...
\begin{tikzpicture}[font=\small]
  ...
  \node[stp box,minimum width=31mm] (asset) at (8.1,0)
    {\textbf{tradeable asset}\\{\scriptsize Paper 4}};
...
execution snapshot --- is owned by the formal-core paper of this volume (Paper~2),
...
will. That is fine for single-operator legibility (Papers~1--2) and fatal for
...
single-operator layers --- Papers~1, 2, and \emph{this} paper --- need and assume.
\DESIGNED.
\end{definition}
...
single-operator threat model. This is the clean boundary the volume's cross-layer
review demanded.}

\paragraph{The second stone's envelope has been standardized --- the stone has
not.} While this volume was being written, the agentic-payments industry shipped
...
The volume is one book precisely because these debts are named in the same words on
