...
\pdcite{bdr04}, the standard technique for reducing a 2-safety hyperproperty
...
\textbf{no \texttt{net\_egress} after \texttt{in\_\allowbreak context\_\allowbreak read} of a secret} & \textbf{read (trigger), egress (gate)} & \textbf{mixed} & \textbf{regimentable: taint, then gate} \\
\bottomrule
\end{tabularx}
\end{table}
...
grade how much of a task a system performs unassisted \pdcite{parasuraman2000}, and
...
false-positive/latency trade-off from Wald's SPRT \pdcite{jpbb04}.
