...
running total with no pre-specified ceiling, and a \pdgloss{privacy filter}{a running differential-privacy ledger that refuses any release which would push cumulative spend past a pre-set ceiling.}
