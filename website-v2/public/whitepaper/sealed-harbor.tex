...
% pdnum id=sealed-pairs kind=arithmetic scope=block
%   expr="comb(4, 2)" value=6 prints="$\binom{4}{2}=6$ unordered pairs"
...
% pdnum id=sealed-basic-32 kind=arithmetic scope=block
%   expr="32 * 0.1" value=3.20 prints="$32\times 0.1=3.20$"
% pdnum id=sealed-basic-128 kind=arithmetic scope=block
%   expr="128 * 0.05" value=6.40 prints="gives $6.40$"
...
% pdnum id=sealed-canary-two kind=arithmetic scope=block
%   expr="1 - 0.2 ** 2" value=0.96 prints="$1-0.04=0.96$"
% pdnum id=sealed-canary-three kind=arithmetic scope=block
%   expr="1 - 0.2 ** 3" value=0.992 prints="three with $1-0.008=0.992$"
