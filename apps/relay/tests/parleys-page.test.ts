...
describe('route wiring (worker.fetch)', () => {
  /**
   * `parleyNotFoundPage` in parleys-page.ts says the quiet part out loud:
   * telling you a parley exists but is closed to you would be its own kind of
   * leak. The router did not hold up its end.
   *
