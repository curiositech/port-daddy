...
async function mintOidcToken(overrides: Record<string, unknown> = {}): Promise<string> {
  ...
  const claims = {
    ...
    sub: `repo:${REPO_OWNER}@99/repo@199:ref:refs/heads/main`,
    ...
    workflow_ref: `${REPO_OWNER}/repo/.github/workflows/ci.yml@refs/heads/main`,
...
function makeEnv(db: D1Database, kv: KVNamespace): Env {
  return {
    ...
    OIDC_GITHUB_TRUST_POLICY_JSON: JSON.stringify({
      ...
      workflowRefs: [`${REPO_OWNER}/repo/.github/workflows/ci.yml@refs/heads/main`],
