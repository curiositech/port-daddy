...
-- configuration screen). One row per (user, repo full name). Additive and
-- forward-only per this directory's README (ADR-0119): staging first via
-- deploy-relay.yml, recorded in applied-staging.json, then prod.
--
-- Design notes:
