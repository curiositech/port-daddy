...
| **AP2** (Google + Coinbase) | Agent Payments Protocol: how agents identify, what credentials they carry, how payments get approved across platforms; **uses x402 as a rail.** Sept 2025. | Authorization framework atop rails. | Cross-platform commerce; not local fleet ops. |
