...
Concretely, the one change: **make the tamper-evident, operator-signed outcome-and-authority ledger the product, and make its core property *adversarial independence* — that it records, signs, and can prove what every agent did *including mine*, in a form the operator owns and a third party can verify, that no vendor can alter, suppress, or be trusted to keep.**
