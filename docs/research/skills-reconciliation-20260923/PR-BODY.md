...
The fail-fast build also exposed a shared pgfplots style error. The repaired execution-report chart retains its logarithmic scale and data; its actual rendered page was inspected. Four build regressions and all 460 research-library tests pass locally. Full-corpus repeated-build verification runs in the pinned hosted toolchain; local BasicTeX lacks `titlesec.sty`.

![Repaired logarithmic chart](https://raw.githubusercontent.com/curiositech/port-daddy/__SOURCE_HEAD__/docs/research/skills-reconciliation-20260923/harbor-build-repair/exec2-page-2.png)
