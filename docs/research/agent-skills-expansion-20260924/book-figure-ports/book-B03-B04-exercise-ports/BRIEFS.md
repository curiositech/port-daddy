...
Full epistemic and source discussion: ../book-B03-B04-followup/REVIEW.md. These figures are teaching applications of established distinctions, not empirical results or new theorems. The retained Swiss standalone and page wrappers target a 4.5-inch column. Captions are candidate-local only.
...
The search rows are three alternative constructed cases, each with its own fixed evaluation instance, model and checker; they do not claim a sound checker returns contradictory answers for the same unchanged plan instance. The retained Swiss source uses square filled marks.
