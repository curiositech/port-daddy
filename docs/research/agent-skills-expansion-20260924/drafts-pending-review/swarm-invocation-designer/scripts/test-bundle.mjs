...
const cases = [
  ...
  ,["null contract", null, false]
  ,["nodes object", (() => { const x=clone(); x.nodes={}; return x; })(), false]
  ,["null node", (() => { const x=clone(); x.nodes=[null]; return x; })(), false]
  ,["members object", (() => { const x=clone(); x.gathers[0].members={}; return x; })(), false]
  ,["blank contract id", (() => { const x=clone(); x.contractId=''; return x; })(), false]
  ,["blank objective", (() => { const x=clone(); x.intent.objective=' '; return x; })(), false]
  ,["bogus terminal", (() => { const x=clone(); x.terminalStatus='BOGUS'; return x; })(), false]
  ,["fractional concurrency", (() => { const x=clone(); x.limits.maxConcurrency=1.5; return x; })(), false]
  ,["empty gather", (() => { const x=clone(); x.gathers[0].members=[]; return x; })(), false]
  ,["unbound gather", (() => { const x=clone(); x.nodes[2].id='unbound'; return x; })(), false]
  ,["no static evidence", (() => { const x=clone(); x.evidence.staticLocators=[]; return x; })(), false]
];
const failures=[];
