...
The named role promotions are local design examples and may not exist or be current in another project. Preserve their concern/ledger/handover detail, but require a current inventory, a standing authority boundary, an alternate, and independent checks before claiming responsibility. Promotion never grants unreviewed effect authority.
...
- Already singleton, scheduled, with a private output surface
  ...
  register its obligation first — it's the most essential ship.
