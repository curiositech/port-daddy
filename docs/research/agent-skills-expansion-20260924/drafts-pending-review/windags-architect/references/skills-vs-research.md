...
**Hypothesis**: Reuse may avoid repeating some discovery work; test total cost and quality against an equal-budget baseline, including skill maintenance and retrieval errors.
...
1. **Build a core skill library first** — A small core selected from observed task coverage; number depends on measured demand
