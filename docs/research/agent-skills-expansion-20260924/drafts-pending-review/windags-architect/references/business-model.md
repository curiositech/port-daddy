# Candidate winDAGs Business Model and Network-Effect Hypotheses

Everything below is a constructed strategy option, not a statement of current product, pricing, marketplace, security certification, or revenue. Validate demand and unit economics before presenting it as a plan.

---

## The Three-Layer Business

One candidate model separates three possible layers:
...
## Candidate Layer 1: Open Source Core (possible free tier)
...
## Candidate Layer 2: Cloud Platform (pricing not validated)
...
## Candidate Layer 3: Skill Marketplace (unvalidated hypothesis)
