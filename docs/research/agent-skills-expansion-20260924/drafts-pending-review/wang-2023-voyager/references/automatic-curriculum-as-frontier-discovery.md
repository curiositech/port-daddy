...
Voyager §2.1 is a Minecraft task-proposal method, not a learned curriculum policy or a general failure result. Keep its concrete state, history, novelty, and observability constraints; treat any threshold, warm-up range, baseline comparison, price, or distributed-orchestrator extension below as a paper-specific observation or constructed engineering proposal. A proposal must be checked against the present environment before execution.
