...
Voyager's library stores executable Minecraft skills and retrieves relevant code. It does not establish catastrophic-forgetting prevention, exponential capability growth, semantic-search correctness, or cross-runtime transfer. Retain the code/reuse examples as design material, but bind every reusable artifact to version, observable preconditions, permitted effects, dependencies, and a fresh-context test.
