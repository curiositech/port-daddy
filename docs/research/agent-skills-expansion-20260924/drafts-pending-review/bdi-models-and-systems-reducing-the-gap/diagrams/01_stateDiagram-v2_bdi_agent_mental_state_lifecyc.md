...
stateDiagram-v2
    ...
    BeliefDesireConsistency: Beliefs ∧ Desires\nConsistent?
    ...
    ExecutionComplete: Action Complete\nOr Failed?
    DeadlineReached: Deadline\nReached?
    OpportunityUnblocked: New Satisfiable\nDesire Detected?
    ImpossibilityDetected: Intention\nImpossible?
    
    ReconsiderationInhibited: Reconsideration\nInhibited?
