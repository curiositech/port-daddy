...
## Source scope and correction (2026-09-24)

Keep the workflow examples and failure cases below as engineering hypotheses or constructed fixtures unless a primary source supports their narrow claim. CSE motivates situated analysis and recovery design; it does not prove that a particular agent lacks expertise, that a pipeline necessarily fails, or that one observed symptom has a single cause.
