...
In the TDAG paper’s ItineraryBench setup, Table 2 reports an average score of 49.08 for full TDAG and 46.69 for the “w/o Agent Generation” ablation. This 2.39 score-point difference is specific to that setup and does not establish that predefined agents fail generally or identify which generation component caused the difference.
...
Table 2 reports a 2.39 average-score-point difference between TDAG (49.08) and its “w/o Agent Generation” ablation (46.69) on ItineraryBench. This bundled ablation does not establish the causal contribution of a specific feature. This seems modest. But consider:
...
In Table 2 of the paper, the Type 3 comparison (combined intra/inter-city planning) show the largest gap: 43.94→46.51 when adding agent generation (Table 2). Type 3 is the most complex, with the most subtask diversity—exactly where you'd expect generated agents to shine.
