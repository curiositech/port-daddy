...
description: >-
  ...
  preference-governed revision. Móra et al. assumes initially consistent beliefs and explicitly leaves belief update
  out of scope; treat any observation-update layer as local. NOT for purely axiomatic modal logic,
...
Use this skill when the main problem is translating a paper-defined BDI model into conformance work. Móra et al., “BDI Models and Systems: Reducing the Gap” (ATAL 1998; LNAI volume 1999), was read in an author-uploaded full-text copy on 2026-09-24. It proposes ELP/WFSX, Event Calculus, abduction, and preference-governed revision; it is not a complete agent implementation, empirical validation, or belief-update algorithm.
...
Keep explicit positive and negative evidence distinct during deliberation, with source, time, scope, and authority. Contradictory evidence must not itself grant contradictory authorization; the cited paper leaves external belief update out of scope.
...
- [`references/paper-scope-and-conformance.md`](references/paper-scope-and-conformance.md) — paper/operator boundary, evidence trace, and golden entailment/non-entailment vector method.
