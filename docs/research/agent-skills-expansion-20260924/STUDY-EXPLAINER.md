...
A bounded repair is now applied to the [study harness](../../../studies/substrate-study/harness/substrates.py): rebase only the task commit, not its unrelated historical ancestors. Four focused [Git regressions](../../../studies/substrate-study/test_rebase_boundary.py) pass with that correction; the original code failed three. The pilot data have not been rerun. Historical pilot numbers stay historical until a corrected, documented experiment is run.
