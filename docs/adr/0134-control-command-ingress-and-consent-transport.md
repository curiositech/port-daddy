# 0134. Control-command ingress and the one consent transport
...
Helmsman (ADR-0131) cannot render a single control or consent card until
both seams close.
...
Backend portability (ADR-0131, operator requirement) makes this matrix the
...
- Binder ch10 / ch17 (CR-1, CR-2) / ch19 (hot+cool interrupt rule, triad) /
  ...
  · `docs/hitl-interruptions.md` · ADR-0046 · ADR-0085 · ADR-0093 · ADR-0131
