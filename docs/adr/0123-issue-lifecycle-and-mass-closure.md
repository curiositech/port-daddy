# 0123. Issue lifecycle — intake redirect, mass closure, and the closer loop
...
the funnel. Helmsman (ADR-0121) never reads issues.
...
- `docs/proposals/pd-helmsman.md` · ADR-0121 · binder ch21/ch23
