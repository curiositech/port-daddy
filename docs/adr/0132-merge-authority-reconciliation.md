# 0132. Merge authority reconciliation — five paths, one audit
...
With Helmsman (ADR-0131) adding a fourth autonomous path (H2 bounded
...
- ADR-0109 (amended), ADR-0053 (deferred enforcement), ADR-0131
