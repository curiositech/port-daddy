...
|------|--------|----------|
| Anchor Protocol white paper | Done | `whitepaper/source/anchor-protocol-whitepaper.tex` (16 pages) |
| Bonded Commons white paper | Done | `whitepaper/source/agent-transactions-whitepaper.tex` (16 pages) |
