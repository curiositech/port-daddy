...
|---|---|---|---|
| Same-owner recovery | `port-daddy-pr10010-runtime-integration-20260905` / `codex/pr10010-runtime-integration-20260905` | `361d6296a` over `aa796d3fd` | [PR #10130](https://github.com/curiositech/port-daddy/pull/10130), correctly stacked on #10010. Recovery security findings below remain open. |
| Release-candidate E2E suite | `port-daddy-release-candidate-e2e-20260905` / `codex/release-candidate-e2e-20260905` | `bcd0139a2` over `a04cab7c0` | [PR #10127](https://github.com/curiositech/port-daddy/pull/10127). Artifact gate is not green. |
| Bounded counter maintenance | `port-daddy-counter-compaction-batches-20260905` / `codex/counter-compaction-batches` | `78c2bbea9` over `afa6b87cc` | [PR #10128](https://github.com/curiositech/port-daddy/pull/10128). Latest fixes need independent validation. Unrelated `.scratch/.DS_Store` left untouched. |
| General App publisher | `port-daddy-fleetbot-pr-publisher-20260905` / `codex/fleetbot-pr-publisher` | `cd6485bbb` over `1499d0702` and `333e46d45` | [PR #10129](https://github.com/curiositech/port-daddy/pull/10129). WIP, not wired or deployed. Historical author metadata preserved. |
...
- [x] Publish the four recovered implementation branches as scoped PRs; same-owner recovery is stacked on #10010 to avoid attributing its dependency's diff to this PR.
