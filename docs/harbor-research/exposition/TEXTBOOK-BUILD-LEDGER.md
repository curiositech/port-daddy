...
| 6 Spawn-to-Person pedagogy (D1) | merge of `wave-6/spawn-to-person-pedagogy` (ef443981d) | `website-v2/public/whitepaper/spawn-to-person.tex`: 39 `pdexercise` pairs from the memo key and four script-backed traces, three worked-number examples, three recitations, the first-edition footnote at `def:sanction-respecting`; the creative pass D2 (Papers 5 and 3 folded, the engine-substitution theorem placed, the open-problem echoes and the rehydration wording) is next |
