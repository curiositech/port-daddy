...
through the slot, and through the slot, only what the contract says. The misread to preempt: the theorem does not say the slot is
safe --- it says the slot is the \emph{only} opening; whether the declared function $g$ releases too much is a contract question
the next two pillars price.
