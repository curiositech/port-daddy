...
In deployed multi-agent platforms (e.g., the Port Daddy daemon and Harbor control plane), the vector stalk $\mathcal{F}(v) \cong \mathbb{R}^D$ is assembled via four deterministic feature pipelines rather than a monolithic embedding:
\begin{enumerate}[noitemsep]
