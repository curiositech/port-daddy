...
| 4 | **CLEAR** | Suspect citation is **real but irrelevant** — excluded on relevance, not authenticity. Add Herlihy–Shavit, Saks–Zaharoglou, Herlihy–Kozlov–Rajsbaum, and PeerReview. All eight existing citations verified accurate; Bach 1999's *content* claim remains `probable` (paywalled) and is critical. |
