...
| Citation | Confidence | Why it matters |
|---|---|---|
| "A Homological Approach to Consensus and Fault Tolerance" (Brazilian general-audience mathematics bulletin) | `uncertain` — **do not cite** | Flagged by its own finding scout as possibly fabricated: venue implausible for the claim, performance figures suspiciously round. Resolve by obtaining the actual PDF or by declaring it not found. |
| M. Herlihy and N. Shavit. "The Topological Structure of Asynchronous Computability." *JACM* 46(6):858–923, 1999. | `verified` (canonical) | **Paper 7 does not cite this and should.** The founding result of topological methods in distributed computing; a referee will not accept a sheaf-theoretic consensus-adjacent paper that omits it. |
| M. Herlihy, D. Kozlov, S. Rajsbaum. *Distributed Computing Through Combinatorial Topology.* Morgan Kaufmann, 2013. | `verified` (canonical) | The standard reference for the whole area; the right single citation if only one is added. |
| M. Saks and F. Zaharoglou. "Wait-Free k-Set Agreement is Impossible: The Topology of Public Knowledge." *SICOMP* 29(5):1449–1483, 2000. | `probable` | Co-winner of the same Gödel Prize; the other half of the founding pair. |
| A. Haeberlen, P. Kouznetsov, P. Druschel. "PeerReview: Practical Accountability for Distributed Systems." *SOSP* 2007, 175–188. | `probable` | Equivocation detection by cross-checking signed logs — the systems-side prior art for Paper 7's exact scenario, currently uncited. |
| E. Buchman, J. Kwon, Z. Milosevic. "The latest gossip on BFT consensus." arXiv:1807.04938, 2018. | `probable` | Standard reference for gossip-based BFT; useful for situating the federation model. |
