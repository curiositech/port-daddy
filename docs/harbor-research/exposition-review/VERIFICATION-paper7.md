...
primary source (`docs/harbor-research/tex/paper7.tex`), verify every quote against it, then attempt to
...
- `/home/user/port-daddy/docs/harbor-research/tex/paper7.tex`
