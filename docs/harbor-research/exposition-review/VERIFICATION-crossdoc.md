...
`federated-harbor-whitepaper.tex` live under `website-v2/public/whitepaper/` (with a
...
### Evidence — Document 1: `/home/user/port-daddy/whitepaper/legible-swarm.tex` L867–877
...
### Evidence — Document 2: `/home/user/port-daddy/docs/harbor-research/tex/paper6.tex` L233–239, L243–254
...
`/home/user/port-daddy/docs/harbor-research/tex/exec5.tex` L155 already books the fix as
outstanding work:
...
`/home/user/port-daddy/whitepaper/single-writer-kernel.tex` L1298 (Table `tab:threat-model`,
...
`whitepaper/figures/fig-swk-continuity-organs.tex` L52–57 (caption of `fig:swk-continuity-organs`):
...
```
./website-v2/public/whitepaper/spawn-to-person.tex:758
./website-v2/public/whitepaper/spawn-to-person.tex:1689
...
./whitepaper/single-writer-kernel.tex:1597
```
...
./whitepaper/single-writer-kernel.tex:1597
./docs/harbor-research/tex/doc1_treatise.tex:54           ← refutation, see below
./docs/harbor-research/tex/review.tex:237                 ← refutation, see below
```

`grep -rn "OP-4" --include=*.tex .`
```
./website-v2/public/whitepaper/spawn-to-person.tex:758, 1689
./website-v2/dist/whitepaper/spawn-to-person.tex:758, 1689
./whitepaper/single-writer-kernel.tex:1073, 1080, 1100, 1484, 1585, 1597, 1631
./whitepaper/figures/fig-swk-continuity-organs.tex:56
```

`grep -rniE "rehydrat|KV[-]?cache|OP-4|prefix cach" docs/harbor-research/tex/paper[1-7].tex`
```
(no matches)
```
...
`docs/harbor-research/tex/doc1_treatise.tex` L54 already adjudicated this exact claim and
ruled against it:
...
`docs/harbor-research/tex/review.tex` L237:
...
Boxed theorem, `/home/user/port-daddy/docs/harbor-research/tex/paper3.tex` L111–119:
...
`/home/user/port-daddy/website-v2/public/whitepaper/federated-harbor-whitepaper.tex`
...
`grep -nE "spectral gap|lambda_2|\\lambda_\{?2|Hansen|Ghrist|relaxation|gossip|Laplacian" docs/harbor-research/tex/paper7.tex`
