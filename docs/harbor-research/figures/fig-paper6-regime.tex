...
\node[shipred,font=\scriptsize,anchor=north west] at (axis cs:0.13,1.13) {false-certify $r{=}1.15$};
\addplot[harborblue,mark=o,mark size=2.4pt,mark options={line width=1.1pt},only marks,forget plot] coordinates {(0.5,1.9)};
\node[harborblue,font=\scriptsize,anchor=south west] at (axis cs:0.53,1.98) {false-reject $r{=}1.9$};
\end{axis}
\end{tikzpicture}
\end{minipage}%
\hfill
