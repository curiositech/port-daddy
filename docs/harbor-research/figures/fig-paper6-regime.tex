...
\node[shipred,font=\scriptsize\itshape,align=left,anchor=west] at (axis cs:0.03,1.55) {$\tilde g$ certifies,\\specialist loses};
\node[harborblue,font=\scriptsize\itshape,align=left,anchor=west] at (axis cs:0.55,1.35) {$\tilde g$ rejects,\\specialist wins};
\end{axis}
\end{tikzpicture}
\end{minipage}%
\hfill
...
\node[shipred,font=\tiny\bfseries,align=center] at (axis cs:0.78,2.25) {pooling wins at\\EVERY skill premium};
\node[seagreen,font=\scriptsize,align=left,anchor=west] at (axis cs:0.03,1.05) {sole ownership viable\\if the premium clears $g_A$};
