...
\node[regimebox,fill=white,fill opacity=0.9,draw=harborblue,font=\scriptsize,inner sep=1.5pt] at (axis cs:0.30,0.20)
  {$H(0.05)=0.286$};
\draw[->,harborblue,thick] (axis cs:0.25,0.19) -- (axis cs:0.06,0.278);
...
\node[font=\scriptsize,harborblue,fill=white,fill opacity=0.9,inner sep=1.5pt] at (axis cs:0.30,0.14) {$R(0.00,0.10)=0.186$};
\draw[->,harborblue] (axis cs:0.25,0.135) -- (axis cs:0.107,0.188);
...
\node[font=\scriptsize,seagreen,fill=white,fill opacity=0.9,inner sep=1.5pt] at (axis cs:0.30,0.08) {$R(0.01,0.10)=0.110$};
\draw[->,seagreen] (axis cs:0.25,0.078) -- (axis cs:0.108,0.113);
...
\node[font=\scriptsize,shipred,fill=white,fill opacity=0.9,inner sep=1.5pt] at (axis cs:0.27,0.02) {$R(0.04,0.06)=0.009$};
\draw[->,shipred] (axis cs:0.22,0.019) -- (axis cs:0.065,0.012);
\end{axis}
\end{tikzpicture}
\end{minipage}%
\hfill
...
\begin{axis}[
  ...
  ylabel={advantage $F/(k\log_2(F/k))$},
...
\node[regimebox,fill=shipred!8,draw=shipred,font=\scriptsize,text width=2.6cm,inner sep=3pt] at (axis cs:0.010,25)
  {measured $15.3\times$\\(ideal $\approx31\times$)};
\draw[->,shipred,thick] (axis cs:0.008,20) -- (axis cs:0.0048,16.5);
\end{axis}
\end{tikzpicture}
\end{minipage}
