...
\begin{axis}[
  ...
  legend style={title={\scriptsize miss tolerance}},
]
...
\node[regimebox,fill=harborblue!8,draw=harborblue,font=\scriptsize,text width=3.3cm,inner sep=3pt] at (axis cs:0.235,0.30)
  {$R(0,f{\to}p)=H(p)=0.286$\\{[verified, Cover--Thomas]}};
\draw[->,harborblue,thick] (axis cs:0.2,0.28) -- (axis cs:0.058,0.28);
...
\node[font=\scriptsize,harborblue] at (axis cs:0.24,0.235) {$R(0.00,0.10)=0.186$ [internal]};
\draw[->,harborblue] (axis cs:0.20,0.232) -- (axis cs:0.107,0.192);
...
\node[font=\scriptsize,seagreen] at (axis cs:0.27,0.15) {$R(0.01,0.10)=0.110$ [internal]};
\draw[->,seagreen] (axis cs:0.23,0.148) -- (axis cs:0.108,0.116);
...
\node[font=\scriptsize,shipred] at (axis cs:0.19,0.055) {$R(0.04,0.06)=0.009$ [internal]};
\draw[->,shipred] (axis cs:0.15,0.052) -- (axis cs:0.065,0.014);
\end{axis}
\end{tikzpicture}
\end{minipage}%
\hfill
...
\begin{axis}[
  ...
  ylabel={open-count advantage $F/(k\log_2(F/k))$},
...
\addlegendentry{sparse regime --- zoom wins}
...
\node[regimebox,fill=shipred!8,draw=shipred,font=\scriptsize,text width=3.4cm,inner sep=3pt] at (axis cs:0.012,45)
  {measured $15.3\times$\\(ideal $\approx31\times$, $\approx2\times$ overhead)\\{[\texttt{b1\_frontier.py}]}};
\draw[->,shipred,thick] (axis cs:0.012,26) -- (axis cs:0.0055,16.2);
\end{axis}
\end{tikzpicture}
\end{minipage}
