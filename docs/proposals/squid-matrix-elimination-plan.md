...
| 21 | `cli/commands/hooks-install.ts` | Installs hooks, heartbeat gate | No change | Heartbeat-gate logic is correct as-is and is central for the RPC-write decision (§3.4) | — |
...
| 37 | `tests/unit/squid-harness.test.ts` | Decisive suite, real K=8 test at line 611 | REWRITE | Perf-at-scale (§6.2a/§6.2b) + adversarial fail-open (§6.1, §6.1a) + K=9 concurrency (§6.7) tests added | PR2/PR3/PR4 |
