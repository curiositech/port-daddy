 ...
 * proofs/coordination/guidance_envelope_v0.pv and refuses to rule the
...
export const GUIDANCE_PROTOCOL_MODEL = {
  adr: 'ADR-0096',
  modelPath: 'proofs/coordination/guidance_envelope_v0.pv',
  resultsPath: 'proofs/coordination/guidance_envelope_v0_results.txt',
