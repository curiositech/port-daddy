...

{
  ...
  // assertRedacted rejects an excerpt still carrying raw content
  let threw = false;
  try {
    assertRedacted({ excerpt: { note: { content: 'sk-ant-api03-RAW1234567890' } } });
  } catch {
    threw = true;
  }
  ok(threw, 'ledger: assertRedacted throws on un-redacted content field');
