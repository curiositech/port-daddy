...
const RULES = [
  ...
  // Absolute home paths leak the machine user + local layout.
  ['home_path_mac', /\/Users\/[^/\s"'`)]+/g, '/Users/<user>'],
  ['home_path_linux', /\/home\/[^/\s"'`)]+/g, '/home/<user>'],
...
module.exports = { redactExcerpt, sha256, RULES };
