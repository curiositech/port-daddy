# Formal analysis — claim-signaling mechanization
...
| `../../z3/economics-delta-threshold/delta-threshold.z3` | SMT-LIB script: the IC cubic + uniqueness in (0, 1) | `z3 ../../z3/economics-delta-threshold/delta-threshold.z3` |
| `../../z3/economics-delta-threshold/delta-threshold.expected.txt` | Expected Z3 output (3 `(check-sat)` results) | (reference; CI greps it) |
...
```bash
z3 ../../z3/economics-delta-threshold/delta-threshold.z3
```
...
- **tla-claim-signaling-apalache** — sets up JDK 17, downloads Apalache
  ...
  `The outcome is: NoError`.
- **tla-conservation** — runs TLC on `whitepaper/formal/tla/bonded-conservation/Conservation.tla`
  (the bonded-commons conservation invariant).
- **monte-carlo-threat-bands** — runs `whitepaper/research/program/simulations/pareto/threat-bands.mjs`
