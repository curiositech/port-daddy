...
\def\wFat{1.8}\def\wMed{0.9}\def\wThin{0.45}
...
\begin{tikzpicture}[pd figure,
  pd panel title/.append style={font=\pdcaptionface\bfseries\footnotesize,text width=3.35cm},
  ...
  \fill[pdcobalt!4] (\bA,\yBase) rectangle (\bB,\yTop);
  \fill[pdteal!4] (\bB,\yBase) rectangle (\bC,\yTop);
  \foreach \y in {\yPrac,\yEng,\ySec,\yEcon,\yPhil} {
    \draw[hhgray!18,line width=0.3pt] (\bA,\y) -- (\bC,\y);
  }
...
\begin{tikzpicture}[pd figure,
  ...
  \fill[pdviolet!4] (\bA,\yBase) rectangle (\bB,\yTop);
  \fill[pdgold!4] (\bB,\yBase) rectangle (\bC,\yTop);
  \foreach \y in {\yPrac,\yEng,\ySec,\yEcon,\yPhil} {
    \draw[hhgray!18,line width=0.3pt] (\bA,\y) -- (\bC,\y);
  }
