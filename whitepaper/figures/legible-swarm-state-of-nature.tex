...
\begin{tikzpicture}[pd figure,x=1cm,y=1cm]
  ...
  \node[pd ready state,result] (AR) at (9.80,4.82)
  ...
  \node[pd breach state,result] (BR) at (9.80,2.62)
  ...
  \node[pd warn state,result] (CR) at (9.80,0.42)
    {\textbf{delayed}\\valid JSON; tests 98\%\\settings path untested};
  \node[pd breach state,result] (CL) at (9.80,-2.10)
