...
% ---------------------------------------------------------------------------
% Margin citations (Wave 16): \pdcite emits the normal \cite plus, in the
% Book, a margin note with a short form per key. The short-form table is
% GENERATED (scripts/harbor-research/build_cite_shortforms.py) and \input
% immediately below, before any chapter body can call \pdcite.
%
