...
\form Resident context is a cache of size $k$ tokens over spans in the durable buffer; span requests follow the agent's action sequence; eviction is online. Load-bearing spans are \emph{pinned} by a feature oracle that an adversary corrupts at rate $\phi$ (mis-pin or missed pin).
