% Pillar IV (Detection) regime: canary detection operating curve (log-log), the broken-secrecy
...
\begin{axis}[
  ...
  title={\textbf{Pillar IV (Detection)} --- the operating curve a CISO can buy, and the boundary that voids it},
...
[internal, \texttt{a4\_canary\_sprt.py}]. The guarantee's decisive regime is secret, uniform planting: an adversary who
