...
**Read first from the repository root**: `whitepaper/research/tex/paper2.tex` in
full — it is short. Then `README.md`, `reading-list.md`, `questions.md`, and
`skills.md` in
`whitepaper/research/deep-dives/flag-2-runtime-enforceability-priority/`.
...
`whitepaper/research/deep-dives/flag-2-runtime-enforceability-priority/findings.md`
