...
- `whitepaper/research/tex/paper1.tex` L34 (Contribution 2):
...
**Corroborating record found in the repo.** `whitepaper/research/wrong-turns/README.md`
...
`whitepaper/research/figures/fig-r4-regime.tex`, plus optionally the generator
...
`whitepaper/research/wrong-turns/a7_experiment.py`. paper1 §Reproducibility
...
Single-token edit in `whitepaper/research/figures/fig-r1-relation.tex` L33:
